...
public final class FlowableOnBackpressureBufferStrategy<T> extends AbstractFlowableWithUpstream<T, T> {
        ...
        public void onNext(T t) {
            ...
            synchronized (deque) {
                ...
                if (deque.size() == this.bufferSize) {
                    int i = C50151.f10536x8ef22ea[this.strategy.ordinal()];
                    if (i == 1) {
                        deque.pollLast();
                        deque.offer(t);
                    } else if (i == 2) {
    ...
    static /* synthetic */ class C50151 {
        ...
        static {
            ...
            try {
                f10536x8ef22ea[BackpressureOverflowStrategy.DROP_OLDEST.ordinal()] = 2;
