...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowExactUnboundedObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Observer<T>, Disposable, Runnable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f10408s, disposable)) {
                this.f10408s = disposable;
        ...
        */
        void drainLoop() {
            ...
            L38:
                ...
                goto L9
            L4d:
                io.reactivex.disposables.Disposable r4 = r7.f10408s
                r4.dispose()
                goto L9
            L53:
    ...
    static final class WindowExactBoundedObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            ...
            if (DisposableHelper.validate(this.f10407s, disposable)) {
                this.f10407s = disposable;
                Observer<? super V> observer = this.actual;
                observer.onSubscribe(this);
                if (this.cancelled) {
                    return;
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f10409s, disposable)) {
                this.f10409s = disposable;
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f10411w);
                        subjectWork.f10411w.onComplete();
        ...
        public static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastSubject<T> f10411w;

            SubjectWork(UnicastSubject<T> unicastSubject, boolean z) {
                this.f10411w = unicastSubject;
                this.open = z;
            }
        }
        ...
        public final class CompletionTask implements Runnable {
            ...
            /* renamed from: w */
            private final UnicastSubject<T> f10410w;

            CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f10410w = unicastSubject;
            }

            @Override // java.lang.Runnable
            public void run() {
                WindowSkipObserver.this.complete(this.f10410w);
            }
        }
    }
}
