...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10247s, subscription)) {
                this.f10247s = subscription;
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                this.f10247s.request(BackpressureHelper.multiplyCap(this.size, j));
            }
        }
    ...
    static final class WindowSkipSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10249s, subscription)) {
                this.f10249s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                if (!this.firstRequest.get() && this.firstRequest.compareAndSet(false, true)) {
                    this.f10249s.request(BackpressureHelper.addCap(BackpressureHelper.multiplyCap(this.size, j), BackpressureHelper.multiplyCap(this.skip - this.size, j - 1)));
                    return;
                }
                this.f10249s.request(BackpressureHelper.multiplyCap(this.skip, j));
            }
        }
    ...
    static final class WindowOverlapSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10248s, subscription)) {
                this.f10248s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        */
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                ...
                if (!this.firstRequest.get() && this.firstRequest.compareAndSet(false, true)) {
                    this.f10248s.request(BackpressureHelper.addCap(this.size, BackpressureHelper.multiplyCap(this.skip, j - 1)));
                } else {
                    this.f10248s.request(BackpressureHelper.multiplyCap(this.skip, j));
                }
                drain();
            }
        }
