...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f10186it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return (T) ObjectHelper.requireNonNull(this.f10186it.next(), "Iterator.next() returned a null value");
        }
