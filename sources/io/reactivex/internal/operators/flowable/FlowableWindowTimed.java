...
public final class FlowableWindowTimed<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactUnboundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10257s, subscription)) {
                this.f10257s = subscription;
        ...
        */
        void drainLoop() {
            ...
            L63:
                ...
                io.reactivex.internal.fuseable.SimplePlainQueue<U> r0 = r10.queue
                r0.clear()
                org.reactivestreams.Subscription r0 = r10.f10257s
                r0.cancel()
                r10.dispose()
                ...
                return
            L7d:
                org.reactivestreams.Subscription r4 = r10.f10257s
                r4.cancel()
                goto L7
            L83:
    ...
    static final class WindowExactBoundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            ...
            if (SubscriptionHelper.validate(this.f10256s, subscription)) {
                this.f10256s = subscription;
                Subscriber<? super V> subscriber = this.actual;
                subscriber.onSubscribe(this);
                if (this.cancelled) {
                    return;
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription, Runnable {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10258s, subscription)) {
                this.f10258s = subscription;
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f10259w);
                        subjectWork.f10259w.onComplete();
        ...
        public static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastProcessor<T> f10259w;

            SubjectWork(UnicastProcessor<T> unicastProcessor, boolean z) {
                this.f10259w = unicastProcessor;
                this.open = z;
            }
        }
