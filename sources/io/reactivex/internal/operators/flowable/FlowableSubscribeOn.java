...
public final class FlowableSubscribeOn<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class SubscribeOnSubscriber<T> extends AtomicReference<Thread> implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        /* renamed from: s */
        final AtomicReference<Subscription> f10231s = new AtomicReference<>();
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.setOnce(this.f10231s, subscription)) {
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                Subscription subscription = this.f10231s.get();
                if (subscription != null) {
                    requestUpstream(j, subscription);
                    return;
                }
                BackpressureHelper.add(this.requested, j);
                Subscription subscription2 = this.f10231s.get();
        ...
        @Override // org.reactivestreams.Subscription
        public void cancel() {
            SubscriptionHelper.cancel(this.f10231s);
            this.worker.dispose();
        }
        ...
        public static final class Request implements Runnable {
            ...
            /* renamed from: s */
            private final Subscription f10233s;

            Request(Subscription subscription, long j) {
                this.f10233s = subscription;
                this.f10232n = j;
            }

            @Override // java.lang.Runnable
            public void run() {
                this.f10233s.request(this.f10232n);
            }
        }
    }
}
