...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10426s, subscription)) {
                this.f10426s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L1b:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelMapTry.C50011.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L8
                if (r6 == r5) goto L51
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C50011 {
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10425s, subscription)) {
                this.f10425s = subscription;
                this.actual.onSubscribe(this);
            }
        }
