...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10419s, subscription)) {
                this.f10419s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L17:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelFilterTry.C50001.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L7
                if (r6 == r5) goto L4d
