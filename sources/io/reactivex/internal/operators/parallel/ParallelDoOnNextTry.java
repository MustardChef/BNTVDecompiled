...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10417s, subscription)) {
                this.f10417s = subscription;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L14:
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C49991.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L8
                if (r6 == r5) goto L4a
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C49991 {
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f10416s, subscription)) {
                this.f10416s = subscription;
                this.actual.onSubscribe(this);
            }
        }
