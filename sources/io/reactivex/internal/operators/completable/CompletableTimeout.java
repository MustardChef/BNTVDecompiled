...
public final class CompletableTimeout extends Completable {
    ...
    static final class TimeOutObserver implements CompletableObserver {
        ...
        /* renamed from: s */
        private final CompletableObserver f10139s;
        private final CompositeDisposable set;

        TimeOutObserver(CompositeDisposable compositeDisposable, AtomicBoolean atomicBoolean, CompletableObserver completableObserver) {
            this.set = compositeDisposable;
            this.once = atomicBoolean;
            this.f10139s = completableObserver;
        }
    ...
    final class DisposeTask implements Runnable {
        ...
        /* renamed from: s */
        final CompletableObserver f10138s;
        final CompositeDisposable set;

        DisposeTask(AtomicBoolean atomicBoolean, CompositeDisposable compositeDisposable, CompletableObserver completableObserver) {
            this.once = atomicBoolean;
            this.set = compositeDisposable;
            this.f10138s = completableObserver;
        }
        ...
        public void run() {
            if (this.once.compareAndSet(false, true)) {
                ...
                if (CompletableTimeout.this.other == null) {
                    this.f10138s.onError(new TimeoutException());
                } else {
        ...
        final class DisposeObserver implements CompletableObserver {
            ...
            public void onError(Throwable th) {
                ...
                DisposeTask.this.f10138s.onError(th);
            }

            @Override // io.reactivex.CompletableObserver, io.reactivex.MaybeObserver
            public void onComplete() {
                DisposeTask.this.set.dispose();
                DisposeTask.this.f10138s.onComplete();
            }
        }
    }
}
