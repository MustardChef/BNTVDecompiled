...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m123as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m122to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C49951.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
