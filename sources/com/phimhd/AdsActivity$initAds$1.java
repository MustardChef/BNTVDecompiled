...
public final class AdsActivity$initAds$1 implements MaxAdListener {
    ...
    public AdsActivity$initAds$1(AdsActivity adsActivity) {
    ...
    public void onAdLoaded(MaxAd ad) {
        Intrinsics.checkNotNullParameter(ad, "ad");
        this.this$0.retryAttemptFullScreen = 0;
    ...
    public void onAdHidden(MaxAd ad) {
        ...
        Intrinsics.checkNotNullParameter(ad, "ad");
        maxInterstitialAd = this.this$0.mInterstitialAd;
    ...
    public void onAdLoadFailed(String adUnitId, MaxError error) {
        ...
        i2 = this.this$0.retryAttemptFullScreen;
        long millis = timeUnit.toMillis((long) Math.pow(2.0d, Math.min(6, i2)));
        Handler handler = new Handler();
        final AdsActivity adsActivity2 = this.this$0;
        handler.postDelayed(new Runnable() { // from class: com.phimhd.-$$Lambda$AdsActivity$initAds$1$AwiPelOVVQaAqinPixFUAUirhbw
            @Override // java.lang.Runnable
            public final void run() {
                AdsActivity$initAds$1.m9031onAdLoadFailed$lambda0(AdsActivity.this);
            }
        }, millis);
    ...
    */
    public static final void m9031onAdLoadFailed$lambda0(com.phimhd.AdsActivity r1) {
        /*
        ...
        L14:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.phimhd.AdsActivity$initAds$1.m9031onAdLoadFailed$lambda0(com.phimhd.AdsActivity):void");
    }
