...
public class torrent_removed_alert extends torrent_alert {
    ...
    public static final int priority = libtorrent_jni.torrent_removed_alert_priority_get();
    ...
    public torrent_removed_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_removed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }
    ...
    public synchronized void delete() {
        if (this.swigCPtr != 0) {
            if (this.swigCMemOwn) {
                ...
                libtorrent_jni.delete_torrent_removed_alert(this.swigCPtr);
            }
            this.swigCPtr = 0L;
        }
        super.delete();
    ...
    public void setInfo_hash(sha1_hash sha1_hashVar) {
        libtorrent_jni.torrent_removed_alert_info_hash_set(this.swigCPtr, this, sha1_hash.getCPtr(sha1_hashVar), sha1_hashVar);
    }

    public sha1_hash getInfo_hash() {
        long j = libtorrent_jni.torrent_removed_alert_info_hash_get(this.swigCPtr, this);
        if (j == 0) {
            return null;
        }
