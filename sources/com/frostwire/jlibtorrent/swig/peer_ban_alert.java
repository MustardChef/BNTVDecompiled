...
public class peer_ban_alert extends peer_alert {
    ...
    public static final alert_category_t static_category = new alert_category_t(libtorrent_jni.peer_ban_alert_static_category_get(), false);

    /* JADX INFO: Access modifiers changed from: protected */
    public peer_ban_alert(long j, boolean z) {
        super(libtorrent_jni.peer_ban_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(peer_ban_alert peer_ban_alertVar) {
        if (peer_ban_alertVar == null) {
            return 0L;
        }
        return peer_ban_alertVar.swigCPtr;
    }
