...
public class torrent_need_cert_alert extends torrent_alert {
    ...
    public torrent_need_cert_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_need_cert_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_need_cert_alert torrent_need_cert_alertVar) {
        if (torrent_need_cert_alertVar == null) {
            return 0L;
        }
        return torrent_need_cert_alertVar.swigCPtr;
    }
