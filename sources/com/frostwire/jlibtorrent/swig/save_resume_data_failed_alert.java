...
public class save_resume_data_failed_alert extends torrent_alert {
    ...
    public static final int priority = libtorrent_jni.save_resume_data_failed_alert_priority_get();
    public static final int alert_type = libtorrent_jni.save_resume_data_failed_alert_alert_type_get();
    public static final alert_category_t static_category = new alert_category_t(libtorrent_jni.save_resume_data_failed_alert_static_category_get(), false);
    ...
    public alert_category_t category() {
        return new alert_category_t(libtorrent_jni.save_resume_data_failed_alert_category(this.swigCPtr, this), true);
    }
