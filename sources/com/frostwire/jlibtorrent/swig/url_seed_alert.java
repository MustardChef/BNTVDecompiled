...
public class url_seed_alert extends torrent_alert {
    ...
    public url_seed_alert(long j, boolean z) {
        super(libtorrent_jni.url_seed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(url_seed_alert url_seed_alertVar) {
        if (url_seed_alertVar == null) {
            return 0L;
        }
        return url_seed_alertVar.swigCPtr;
    }
