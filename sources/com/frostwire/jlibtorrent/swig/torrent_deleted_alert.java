...
public class torrent_deleted_alert extends torrent_alert {
    ...
    public torrent_deleted_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_deleted_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_deleted_alert torrent_deleted_alertVar) {
        if (torrent_deleted_alertVar == null) {
            return 0L;
        }
        return torrent_deleted_alertVar.swigCPtr;
    }
    ...
    public void setInfo_hash(sha1_hash sha1_hashVar) {
        libtorrent_jni.torrent_deleted_alert_info_hash_set(this.swigCPtr, this, sha1_hash.getCPtr(sha1_hashVar), sha1_hashVar);
    }

    public sha1_hash getInfo_hash() {
        long j = libtorrent_jni.torrent_deleted_alert_info_hash_get(this.swigCPtr, this);
        if (j == 0) {
            return null;
        }
