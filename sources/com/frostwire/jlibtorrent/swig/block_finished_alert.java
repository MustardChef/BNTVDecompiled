...
public class block_finished_alert extends peer_alert {
    ...
    public block_finished_alert(long j, boolean z) {
        super(libtorrent_jni.block_finished_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(block_finished_alert block_finished_alertVar) {
        if (block_finished_alertVar == null) {
            return 0L;
        }
        return block_finished_alertVar.swigCPtr;
    }
