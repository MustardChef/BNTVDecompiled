...
public class trackerid_alert extends tracker_alert {
    ...
    public trackerid_alert(long j, boolean z) {
        super(libtorrent_jni.trackerid_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(trackerid_alert trackerid_alertVar) {
        if (trackerid_alertVar == null) {
            return 0L;
        }
        return trackerid_alertVar.swigCPtr;
    }
