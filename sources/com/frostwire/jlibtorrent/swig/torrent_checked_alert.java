...
public class torrent_checked_alert extends torrent_alert {
    ...
    public torrent_checked_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_checked_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_checked_alert torrent_checked_alertVar) {
        if (torrent_checked_alertVar == null) {
            return 0L;
        }
        return torrent_checked_alertVar.swigCPtr;
    }
