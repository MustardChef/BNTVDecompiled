...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', ',', '-', '.', JsonPointer.SEPARATOR, ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', '\\', ']', '^', '_'};
    ...
    public static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                int i = C46621.f9860xb73eb560[mode.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C46621 {
        ...
        static final /* synthetic */ int[] f9860xb73eb560;
        ...
        static {
            ...
            try {
                f9860xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9860xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9860xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9860xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
