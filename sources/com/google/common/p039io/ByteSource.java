...
public abstract class ByteSource {
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m320of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p039io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m320of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.p039io.ByteSource.ByteArrayByteSource
        public String toString() {
        ...
        @Override // com.google.common.p039io.ByteSource.ByteArrayByteSource, com.google.common.p039io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            for (ByteSource byteSource : iterable) {
                ...
                if (j < 0) {
                    return Optional.m320of(Long.MAX_VALUE);
                }
            }
            return Optional.m320of(Long.valueOf(j));
        }
