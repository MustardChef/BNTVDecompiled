...
public final class TopKSelector<T> {
    ...
    private void trim() {
        ...
        while (true) {
            ...
            if (this.comparator.compare((Object) this.buffer[i4], (T) this.threshold) > 0) {
                this.threshold = this.buffer[i4];
            }
        }
    }
    ...
    private int partition(int i, int i2, int i3) {
        ...
        int i4 = i;
        while (i < i2) {
            if (this.comparator.compare((Object) this.buffer[i], t) < 0) {
                swap(i4, i);
                i4++;
            }
            i++;
