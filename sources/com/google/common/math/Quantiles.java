        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                if (i < iArr7.length) {
                    ...
                    int i8 = iArr4[i];
                    if (i8 == 0) {
                        hashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(dArr[i7]));
                    } else {
                        hashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i7], dArr[i7 + 1], i8, this.scale)));
                    }
                    i++;
                } else {
