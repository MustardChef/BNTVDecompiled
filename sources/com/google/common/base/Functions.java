...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f9771f;

        /* renamed from: g */
        private final Function<B, C> f9772g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f9772g = (Function) Preconditions.checkNotNull(function);
            this.f9771f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        public C apply(@NullableDecl A a) {
            return this.f9772g.apply(this.f9771f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            if (obj instanceof FunctionComposition) {
                ...
                return this.f9771f.equals(functionComposition.f9771f) && this.f9772g.equals(functionComposition.f9772g);
            }
            return false;
        }

        public int hashCode() {
            return this.f9771f.hashCode() ^ this.f9772g.hashCode();
        }

        public String toString() {
            return this.f9772g + "(" + this.f9771f + ")";
        }
    }
