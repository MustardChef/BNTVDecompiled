...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m324is(char c) {
        return new C3934Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length != 0) {
            ...
            return m324is(charSequence.charAt(0));
        }
        return none();
    }
    ...
    /* renamed from: or */
    public CharMatcher mo323or(CharMatcher charMatcher) {
        return new C3935Or(this, charMatcher);
    }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i, bitSet, str)) { // from class: com.google.common.base.CharMatcher.1
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        if (i != 0) {
            ...
            return m324is((char) bitSet.nextSetBit(0));
        }
        return none();
    }
    ...
    /* loaded from: classes3.dex */
    public static final class C3935Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C3935Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* loaded from: classes3.dex */
    public static final class C3934Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo323or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo323or(charMatcher);
        }
