...
public abstract class AbstractSpiCall {
    ...
    public HttpRequest getHttpRequest(Map<String, String> map) {
        ...
        return buildHttpRequest.header("User-Agent", CRASHLYTICS_USER_AGENT + CrashlyticsCore.getVersion()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
