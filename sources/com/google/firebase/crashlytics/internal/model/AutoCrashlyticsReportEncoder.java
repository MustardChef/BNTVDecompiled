...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder(C4519x7e3e3ebd.class, CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, C4501xc3999712.INSTANCE);
        encoderConfig.registerEncoder(C4521xce3d994b.class, C4501xc3999712.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Exception.class, C4500x55689506.INSTANCE);
        encoderConfig.registerEncoder(C4515xc2f5febc.class, C4500x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder(C4517x7c929f5b.class, CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, C4499x99c932db.INSTANCE);
        encoderConfig.registerEncoder(C4513xfe724d07.class, C4499x99c932db.INSTANCE);
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        public void encode(CrashlyticsReport.Session.Application application, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, application.getVersion());
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        public void encode(CrashlyticsReport.Session.OperatingSystem operatingSystem, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, operatingSystem.getVersion());
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        public void encode(CrashlyticsReport.Session.Device device, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ServerProtocol.DIALOG_PARAM_STATE, device.getState());
    ...
    /* loaded from: classes3.dex */
    private static final class C4501xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C4501xc3999712 INSTANCE = new C4501xc3999712();

        private C4501xc3999712() {
        }
    ...
    /* loaded from: classes3.dex */
    private static final class C4500x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C4500x55689506 INSTANCE = new C4500x55689506();

        private C4500x55689506() {
        }
    ...
    /* loaded from: classes3.dex */
    private static final class C4499x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C4499x99c932db INSTANCE = new C4499x99c932db();

        private C4499x99c932db() {
        }
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        public void encode(CrashlyticsReport.CustomAttribute customAttribute, ObjectEncoderContext objectEncoderContext) throws IOException {
            objectEncoderContext.add(SDKConstants.PARAM_KEY, customAttribute.getKey());
