...
public final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
    ...
    public void flush(final MediaCodec mediaCodec) {
        synchronized (this.lock) {
            ...
            ((Handler) Util.castNonNull(this.handler)).post(new Runnable() { // from class: com.google.android.exoplayer2.mediacodec.-$$Lambda$AsynchronousMediaCodecCallback$5YjSglQq4fWdD8B1ovA48fYtsz4
                @Override // java.lang.Runnable
                public final void run() {
                    AsynchronousMediaCodecCallback.this.lambda$flush$0$AsynchronousMediaCodecCallback(mediaCodec);
                }
            });
        }
    }
    ...
    public void lambda$flush$0$AsynchronousMediaCodecCallback(MediaCodec mediaCodec) {
        synchronized (this.lock) {
            if (this.shutDown) {
                return;
            }
