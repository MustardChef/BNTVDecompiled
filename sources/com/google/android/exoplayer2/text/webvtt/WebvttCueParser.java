...
public final class WebvttCueParser {
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m379w(TAG, valueOf.length() != 0 ? "Skipping cue with bad header: ".concat(valueOf) : new String("Skipping cue with bad header: "));
            return null;
        }
    }
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                String valueOf = String.valueOf(matcher.group());
                Log.m379w(TAG, valueOf.length() != 0 ? "Skipping bad cue setting: ".concat(valueOf) : new String("Skipping bad cue setting: "));
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (c) {
            ...
            default:
                ...
                Log.m379w(TAG, valueOf.length() != 0 ? "Invalid anchor value: ".concat(valueOf) : new String("Invalid anchor value: "));
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        String valueOf = String.valueOf(str);
        Log.m379w(TAG, valueOf.length() != 0 ? "Invalid 'vertical' value: ".concat(valueOf) : new String("Invalid 'vertical' value: "));
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (c) {
            ...
            default:
                String valueOf = String.valueOf(str);
                Log.m379w(TAG, valueOf.length() != 0 ? "Invalid alignment value: ".concat(valueOf) : new String("Invalid alignment value: "));
                return 2;
        }
    }
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            ...
                            sb.append(i);
                            Log.m379w(WebvttCueParser.TAG, sb.toString());
                            return null;
                        }
                    }
                }
    ...
    public static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = $$Lambda$WebvttCueParser$Element$VyiDJ7qRfxCLGd6CXvAWYb7Vhxg.INSTANCE;
