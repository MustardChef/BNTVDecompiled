...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private void handleG2Character(int i) {
        if (i == 32) {
            ...
            this.currentCueInfoBuilder.append(Typography.f10677tm);
        } else if (i == 58) {
    ...
    public static final class Cea708CueInfo {
        private static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = C3513xf2191238.INSTANCE;
