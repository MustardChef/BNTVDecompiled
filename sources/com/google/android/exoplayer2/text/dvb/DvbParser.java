...
final class DvbParser {
    ...
    private static final byte[] defaultMap2To4 = {0, 7, 8, Ascii.f9766SI};
    ...
    private static void parseSubtitlingSegment(ParsableBitArray parsableBitArray, SubtitleService subtitleService) {
        ...
        if (readBits3 * 8 > parsableBitArray.bitsLeft()) {
            Log.m379w(TAG, "Data field length exceeds limit");
        ...
        switch (readBits) {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0 && (regionComposition = subtitleService.regions.get(parseRegionComposition.f9694id)) != null) {
                        parseRegionComposition.mergeFrom(regionComposition);
                    }
                    subtitleService.regions.put(parseRegionComposition.f9694id, parseRegionComposition);
                    break;
                }
                break;
            case 18:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(parseClutDefinition.f9692id, parseClutDefinition);
                    break;
                    ...
                    subtitleService.ancillaryCluts.put(parseClutDefinition2.f9692id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(parseObjectData.f9693id, parseObjectData);
                    break;
                } else if (readBits2 == subtitleService.ancillaryPageId) {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(parseObjectData2.f9693id, parseObjectData2);
                    break;
                }
                break;
            case 20:
