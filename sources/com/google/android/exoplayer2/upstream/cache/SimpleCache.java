...
public final class SimpleCache implements Cache {
    ...
    public synchronized void release() {
        ...
        try {
            ...
            Log.m382e(TAG, "Storing index file failed", e);
            unlockFolder(this.cacheDir);
        }
        this.released = true;
    }
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f9699id, j, System.currentTimeMillis());
    }
    ...
    public void initialize() {
        ...
        try {
            ...
            try {
                ...
                Log.m382e(TAG, "Storing index file failed", e3);
            }
        ...
        if (this.touchCacheSpans) {
            ...
            if (cacheFileMetadataIndex != null) {
                try {
                    ...
                    Log.m379w(TAG, "Failed to update index with new touch timestamp.");
                }
            } else {
                z = true;
            }
    ...
    private void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                Log.m379w(TAG, valueOf.length() != 0 ? "Failed to remove file index entry for: ".concat(valueOf) : new String("Failed to remove file index entry for: "));
            }
        }
        this.contentIndex.maybeRemove(cachedContent.key);
