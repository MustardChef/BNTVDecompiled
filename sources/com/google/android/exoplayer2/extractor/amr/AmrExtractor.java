...
public final class AmrExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = $$Lambda$AmrExtractor$w_M83VVDu2orWPcXnpV9hzd2g.INSTANCE;
    ...
    private void maybeOutputSeekMap(long j, int i) {
        ...
        if ((i3 & 1) == 0 || j == -1 || ((i2 = this.firstSampleSize) != -1 && i2 != this.currentSampleSize)) {
            SeekMap.Unseekable unseekable = new SeekMap.Unseekable(C3282C.TIME_UNSET);
