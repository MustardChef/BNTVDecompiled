...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.durationUs = C3282C.TIME_UNSET;
        this.pendingSeekTimeUs = C3282C.TIME_UNSET;
        this.segmentIndexEarliestPresentationTimeUs = C3282C.TIME_UNSET;
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), j, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.-$$Lambda$Xle2kybCcBDfaYt4nAECb1zk9Sg
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f9668id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f9668id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f9668id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f9668id));
            i++;
        }
    }
    ...
    private void onMoofContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.pendingSeekTimeUs != C3282C.TIME_UNSET) {
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (parseFullAtomVersion == 0) {
            ...
            long j3 = j2 != C3282C.TIME_UNSET ? j2 + scaleLargeTimestamp : -9223372036854775807L;
            str = str3;
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (trackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m379w(TAG, "Ignoring negative offset to sample data.");
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (parseUuid == null) {
                    Log.m379w(TAG, "Skipped pssh atom (failed to extract uuid)");
                } else {
