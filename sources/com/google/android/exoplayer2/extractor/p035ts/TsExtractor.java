...
public final class TsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = $$Lambda$TsExtractor$bYe9QyXe_uycRO2FcbUvfjPyNo.INSTANCE;
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean z = timestampAdjuster.getTimestampOffsetUs() == C3282C.TIME_UNSET;
            if (!z) {
                long firstSampleTimestampUs = timestampAdjuster.getFirstSampleTimestampUs();
                z = (firstSampleTimestampUs == C3282C.TIME_UNSET || firstSampleTimestampUs == 0 || firstSampleTimestampUs == j2) ? false : true;
            }
            if (z) {
