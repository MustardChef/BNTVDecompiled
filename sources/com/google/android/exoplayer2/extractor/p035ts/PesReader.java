...
public final class PesReader implements TsPayloadReader {
    ...
    @Override // com.google.android.exoplayer2.extractor.p035ts.TsPayloadReader
    ...
    public final void consume(ParsableByteArray parsableByteArray, int i) throws ParserException {
        ...
        if ((i & 1) != 0) {
            ...
            if (i2 != 0 && i2 != 1) {
                if (i2 == 2) {
                    Log.m379w(TAG, "Unexpected start indicator reading extended header");
                } else if (i2 == 3) {
