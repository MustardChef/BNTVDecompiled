...
public class MatroskaExtractor implements Extractor {
    ...
    MatroskaExtractor(EbmlReader ebmlReader, int i) {
        ...
        this.timecodeScale = C3282C.TIME_UNSET;
        this.durationTimecode = C3282C.TIME_UNSET;
        this.durationUs = C3282C.TIME_UNSET;
        this.cuesContentPosition = -1L;
        this.seekPositionAfterBuildingCues = -1L;
        this.clusterTimecodeUs = C3282C.TIME_UNSET;
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == 160) {
            ...
            if (this.currentTrack.hasContentEncryption) {
                ...
                this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C3282C.UUID_NIL, MimeTypes.VIDEO_WEBM, this.currentTrack.cryptoData.encryptionKey));
            }
            ...
            if (this.timecodeScale == C3282C.TIME_UNSET) {
    ...
    */
    private void commitSampleToOutput(com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor.Track r18, long r19, int r21, int r22, int r23) {
        ...
        L32:
            ...
            com.google.android.exoplayer2.util.Log.m379w(r3, r2)
            goto L4e
        L3e:
    ...
    private static byte[] formatSubtitleTimecode(long j, String str, long j2) {
        Assertions.checkArgument(j != C3282C.TIME_UNSET);
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        int i;
        if (this.segmentContentPosition == -1 || this.durationUs == C3282C.TIME_UNSET || longArray == null || longArray.size() == 0 || longArray2 == null || longArray2.size() != longArray.size()) {
        ...
        */
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m379w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
