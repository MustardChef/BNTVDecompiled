...
import com.google.android.exoplayer2.p036ui.AspectRatioFrameLayout;
...
public class StyledPlayerView extends FrameLayout implements AdViewProvider {
    ...
    public StyledPlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i8 = C3559R.C3563layout.exo_styled_player_view;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C3559R.styleable.StyledPlayerView, i, 0);
            try {
                boolean hasValue = obtainStyledAttributes.hasValue(C3559R.styleable.StyledPlayerView_shutter_background_color);
                int color = obtainStyledAttributes.getColor(C3559R.styleable.StyledPlayerView_shutter_background_color, 0);
                int resourceId = obtainStyledAttributes.getResourceId(C3559R.styleable.StyledPlayerView_player_layout_id, i8);
                boolean z9 = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_use_artwork, true);
                int resourceId2 = obtainStyledAttributes.getResourceId(C3559R.styleable.StyledPlayerView_default_artwork, 0);
                boolean z10 = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_use_controller, true);
                int i9 = obtainStyledAttributes.getInt(C3559R.styleable.StyledPlayerView_surface_type, 1);
                int i10 = obtainStyledAttributes.getInt(C3559R.styleable.StyledPlayerView_resize_mode, 0);
                int i11 = obtainStyledAttributes.getInt(C3559R.styleable.StyledPlayerView_show_timeout, 5000);
                boolean z11 = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_hide_on_touch, true);
                boolean z12 = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_auto_show, true);
                i4 = obtainStyledAttributes.getInteger(C3559R.styleable.StyledPlayerView_show_buffering, 0);
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z13 = obtainStyledAttributes.getBoolean(C3559R.styleable.StyledPlayerView_hide_during_ads, true);
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = (AspectRatioFrameLayout) findViewById(C3559R.C3562id.exo_content_frame);
        this.contentFrame = aspectRatioFrameLayout;
        if (aspectRatioFrameLayout != null) {
            setResizeModeRaw(aspectRatioFrameLayout, i3);
        }
        View findViewById = findViewById(C3559R.C3562id.exo_shutter);
        ...
        this.adOverlayFrameLayout = (FrameLayout) findViewById(C3559R.C3562id.exo_ad_overlay);
        this.overlayFrameLayout = (FrameLayout) findViewById(C3559R.C3562id.exo_overlay);
        ImageView imageView2 = (ImageView) findViewById(C3559R.C3562id.exo_artwork);
        this.artworkView = imageView2;
        this.useArtwork = z5 && imageView2 != null;
        if (i7 != 0) {
            this.defaultArtwork = ContextCompat.getDrawable(getContext(), i7);
        }
        SubtitleView subtitleView = (SubtitleView) findViewById(C3559R.C3562id.exo_subtitles);
        this.subtitleView = subtitleView;
        if (subtitleView != null) {
            subtitleView.setUserDefaultStyle();
            subtitleView.setUserDefaultTextSize();
        }
        View findViewById2 = findViewById(C3559R.C3562id.exo_buffering);
        this.bufferingView = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setVisibility(8);
        }
        this.showBuffering = i4;
        TextView textView = (TextView) findViewById(C3559R.C3562id.exo_error_message);
        this.errorMessageView = textView;
        if (textView != null) {
            textView.setVisibility(8);
        }
        StyledPlayerControlView styledPlayerControlView = (StyledPlayerControlView) findViewById(C3559R.C3562id.exo_controller);
        View findViewById3 = findViewById(C3559R.C3562id.exo_controller_placeholder);
        if (styledPlayerControlView != null) {
            this.controller = styledPlayerControlView;
        } else if (findViewById3 != null) {
            StyledPlayerControlView styledPlayerControlView2 = new StyledPlayerControlView(context, null, 0, attributeSet);
            this.controller = styledPlayerControlView2;
            styledPlayerControlView2.setId(C3559R.C3562id.exo_controller);
    ...
    @Override // com.google.android.exoplayer2.p036ui.AdViewProvider
    ...
    public void updateContentDescription() {
        ...
        if (styledPlayerControlView == null || !this.useController) {
            ...
            setContentDescription(this.controllerHideOnTouch ? getResources().getString(C3559R.string.exo_controls_hide) : null);
        } else {
            setContentDescription(getResources().getString(C3559R.string.exo_controls_show));
        }
    }
    ...
    private static void configureEditModeLogoV23(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C3559R.C3561drawable.exo_edit_mode_logo, null));
        imageView.setBackgroundColor(resources.getColor(C3559R.C3560color.exo_edit_mode_background_color, null));
    }

    private static void configureEditModeLogo(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C3559R.C3561drawable.exo_edit_mode_logo));
        imageView.setBackgroundColor(resources.getColor(C3559R.C3560color.exo_edit_mode_background_color));
    }
    ...
    public final class ComponentListener implements Player.Listener, View.OnLayoutChangeListener, View.OnClickListener, StyledPlayerControlView.VisibilityListener {
        ...
        @Override // com.google.android.exoplayer2.p036ui.StyledPlayerControlView.VisibilityListener
