...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = $$Lambda$Id3Decoder$WmYB9iemPK4h_cIYDuj0g_KGc.INSTANCE;
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m379w(TAG, "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedInt24 != 4801587) {
            ...
            Log.m379w(TAG, valueOf.length() != 0 ? "Unexpected first three bytes of ID3 tag header: 0x".concat(valueOf) : new String("Unexpected first three bytes of ID3 tag header: 0x"));
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m379w(TAG, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
    ...
    */
    ...
    private static UrlLinkFrame decodeWxxxFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        String str = new String(bArr, 0, indexOfEos, charsetName);
        int delimiterLength = indexOfEos + delimiterLength(readUnsignedByte);
        return new UrlLinkFrame("WXXX", str, decodeStringIfValid(bArr, delimiterLength, indexOfZeroByte(bArr, delimiterLength), C3282C.ISO88591_NAME));
    }
    ...
    private static UrlLinkFrame decodeUrlLinkFrame(ParsableByteArray parsableByteArray, int i, String str) throws UnsupportedEncodingException {
        ...
        return new UrlLinkFrame(str, null, new String(bArr, 0, indexOfZeroByte(bArr, 0), C3282C.ISO88591_NAME));
    }
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, C3282C.ISO88591_NAME), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, i));
    }
    ...
    private static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        parsableByteArray.readBytes(bArr, 0, i2);
        int indexOfZeroByte = indexOfZeroByte(bArr, 0);
        String str = new String(bArr, 0, indexOfZeroByte, C3282C.ISO88591_NAME);
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            String valueOf = String.valueOf(Ascii.toLowerCase(new String(bArr, 0, 3, C3282C.ISO88591_NAME)));
            ...
            String lowerCase = Ascii.toLowerCase(new String(bArr, 0, indexOfZeroByte, C3282C.ISO88591_NAME));
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate) throws UnsupportedEncodingException {
        ...
        String str = new String(parsableByteArray.getData(), position, indexOfZeroByte - position, C3282C.ISO88591_NAME);
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate) throws UnsupportedEncodingException {
        ...
        for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
            ...
            strArr[i4] = new String(parsableByteArray.getData(), position2, indexOfZeroByte2 - position2, C3282C.ISO88591_NAME);
