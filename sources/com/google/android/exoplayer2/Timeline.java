...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator<Timeline> CREATOR = $$Lambda$Timeline$4eWR_EQUMv6FYlKol3461jBhxV8.INSTANCE;
    ...
    public static final class Window implements Bundleable {
        ...
        public static final Bundleable.Creator<Window> CREATOR = $$Lambda$Timeline$Window$DwPhLG2u8bNdNcFO2XKtY2D8gVM.INSTANCE;
        ...
        public int hashCode() {
            int hashCode = (((bqk.f6556bP + this.uid.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(keyForField(2), C3282C.TIME_UNSET);
            long j2 = bundle.getLong(keyForField(3), C3282C.TIME_UNSET);
            long j3 = bundle.getLong(keyForField(4), C3282C.TIME_UNSET);
            ...
            long j5 = bundle.getLong(keyForField(10), C3282C.TIME_UNSET);
    ...
    public static final class Period implements Bundleable {
        public static final Bundleable.Creator<Period> CREATOR = $$Lambda$Timeline$Period$cb0Ll1d1tnVYwhQwGd9j2fWlJfI.INSTANCE;
        ...
        public long getAdDurationUs(int i, int i2) {
            ...
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C3282C.TIME_UNSET;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Util.areEqual(this.f9656id, period.f9656id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState);
        }

        public int hashCode() {
            Object obj = this.f9656id;
            int hashCode = (bqk.f6556bP + (obj == null ? 0 : obj.hashCode())) * 31;
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(keyForField(1), C3282C.TIME_UNSET);
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int i, long j, long j2) {
        ...
        if (period.durationUs != C3282C.TIME_UNSET) {
    ...
    public int hashCode() {
        Window window = new Window();
        Period period = new Period();
        int windowCount = bqk.f6556bP + getWindowCount();
        for (int i = 0; i < getWindowCount(); i++) {
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f9656id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
