...
public final class Format implements Bundleable {
    ...
    public static final Bundleable.Creator<Format> CREATOR = $$Lambda$Format$4wXnd4xtd49V1jolbzSo3RtlsBw.INSTANCE;
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f9653id = Integer.toString(i);
            return this;
        }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
                ...
                if (uuid.equals(C3282C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add(C3282C.CENC_TYPE_cenc);
                } else if (uuid.equals(C3282C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C3282C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C3282C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C3282C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            sb.append(Joiner.m322on(',').join(linkedHashSet));
            sb.append(']');
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(keyForField(0), this.f9652id);
