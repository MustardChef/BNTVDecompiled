...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    */
    ...
    protected ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                j = parseLong(xmlPullParser, TypedValues.AttributesType.S_TARGET, C3282C.TIME_UNSET);
                j2 = parseLong(xmlPullParser, "min", C3282C.TIME_UNSET);
                j3 = parseLong(xmlPullParser, AppLovinMediationProvider.MAX, C3282C.TIME_UNSET);
    ...
    protected Pair<Period, Long> parsePeriod(XmlPullParser xmlPullParser, List<BaseUrl> list, long j, long j2, long j3, long j4) throws XmlPullParserException, IOException {
        ...
        long j7 = C3282C.TIME_UNSET;
        long j8 = j3 != C3282C.TIME_UNSET ? j3 + parseDuration : -9223372036854775807L;
        long parseDuration2 = parseDuration(xmlPullParser, TypedValues.TransitionType.S_DURATION, C3282C.TIME_UNSET);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "BaseURL")) {
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser, "AdaptationSet")) {
                    ...
                    arrayList = arrayList6;
                    arrayList2 = arrayList4;
                    arrayList2.add(parseAdaptationSet(xmlPullParser, !arrayList6.isEmpty() ? arrayList6 : list, singleSegmentBase, parseDuration2, j9, j10, j8, j4));
                    arrayList3 = arrayList5;
                } else {
                    j5 = j9;
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser, "EventStream")) {
                        ...
                        arrayList3 = arrayList7;
                        singleSegmentBase = parseSegmentBase(xmlPullParser, null);
                        obj = null;
                        j9 = j5;
                        j6 = C3282C.TIME_UNSET;
                    } else {
                        arrayList3 = arrayList7;
                        if (XmlPullParserUtil.isStartTag(xmlPullParser, "SegmentList")) {
                            long parseAvailabilityTimeOffsetUs = parseAvailabilityTimeOffsetUs(xmlPullParser, C3282C.TIME_UNSET);
                            obj = null;
                            ...
                            if (XmlPullParserUtil.isStartTag(xmlPullParser, "SegmentTemplate")) {
                                long parseAvailabilityTimeOffsetUs2 = parseAvailabilityTimeOffsetUs(xmlPullParser, C3282C.TIME_UNSET);
                                j6 = -9223372036854775807L;
                                parseSegmentTemplate = parseSegmentTemplate(xmlPullParser, null, ImmutableList.m295of(), j8, parseDuration2, j5, parseAvailabilityTimeOffsetUs2, j4);
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x031d A[LOOP:0: B:3:0x007c->B:74:0x031d, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:75:0x02de A[EDGE_INSN: B:75:0x02de->B:68:0x02de ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:57:0x01ea A[LOOP:0: B:3:0x006a->B:57:0x01ea, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:58:0x0194 A[EDGE_INSN: B:58:0x0194->B:47:0x0194 ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    protected SegmentBase.SegmentList parseSegmentList(XmlPullParser xmlPullParser, SegmentBase.SegmentList segmentList, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        long parseLong3 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, segmentList != null ? segmentList.duration : C3282C.TIME_UNSET);
    ...
    protected SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xmlPullParser, SegmentBase.SegmentTemplate segmentTemplate, List<Descriptor> list, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        long parseLong3 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, segmentTemplate != null ? segmentTemplate.duration : C3282C.TIME_UNSET);
    ...
    protected Pair<Long, EventMessage> parseEvent(XmlPullParser xmlPullParser, String str, String str2, long j, ByteArrayOutputStream byteArrayOutputStream) throws IOException, XmlPullParserException {
        ...
        long parseLong2 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, C3282C.TIME_UNSET);
    ...
    protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j, long j2) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, ExifInterface.LATITUDE_SOUTH)) {
                long parseLong = parseLong(xmlPullParser, "t", C3282C.TIME_UNSET);
                if (z) {
                    j3 = addSegmentTimelineElementsToList(arrayList, j3, j4, i, parseLong);
                }
                if (parseLong == C3282C.TIME_UNSET) {
                    parseLong = j3;
                }
                j4 = parseLong(xmlPullParser, "d", C3282C.TIME_UNSET);
    ...
    protected int parseSelectionFlagsFromDashRoleScheme(String str) {
        ...
        return !str.equals(MediaTrack.ROLE_MAIN) ? 0 : 1;
    }
    ...
    protected static int parseCea608AccessibilityChannel(List<Descriptor> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri) && descriptor.value != null) {
                ...
                Log.m379w(TAG, valueOf.length() != 0 ? "Unable to parse CEA-608 channel number from: ".concat(valueOf) : new String("Unable to parse CEA-608 channel number from: "));
            }
        }
        return -1;
    }
    ...
    protected static int parseCea708AccessibilityChannel(List<Descriptor> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-708:2015".equals(descriptor.schemeIdUri) && descriptor.value != null) {
                ...
                String valueOf = String.valueOf(descriptor.value);
                Log.m379w(TAG, valueOf.length() != 0 ? "Unable to parse CEA-708 service block number from: ".concat(valueOf) : new String("Unable to parse CEA-708 service block number from: "));
            }
        }
        return -1;
    }
