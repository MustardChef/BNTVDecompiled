...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private long maxLoadedChunkEndTimeUs = C3282C.TIME_UNSET;
        ...
        public void onChunkLoadCompleted(Chunk chunk) {
            if (this.maxLoadedChunkEndTimeUs == C3282C.TIME_UNSET || chunk.endTimeUs > this.maxLoadedChunkEndTimeUs) {
        ...
        public boolean onChunkLoadError(Chunk chunk) {
            ...
            return PlayerEmsgHandler.this.onChunkLoadError(j != C3282C.TIME_UNSET && j < chunk.startTimeUs);
        }
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (manifestPublishTimeMsInEmsg == C3282C.TIME_UNSET) {
                return;
            }
