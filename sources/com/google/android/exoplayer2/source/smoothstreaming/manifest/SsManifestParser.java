...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    public static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamFragmentStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            long parseLong = parseLong(xmlPullParser, KEY_FRAGMENT_START_TIME, C3282C.TIME_UNSET);
            int i = 1;
            ...
            this.lastChunkDuration = parseLong(xmlPullParser, KEY_FRAGMENT_DURATION, C3282C.TIME_UNSET);
            long parseLong2 = parseLong(xmlPullParser, KEY_FRAGMENT_REPEAT_COUNT, 1L);
            if (parseLong2 > 1 && this.lastChunkDuration == C3282C.TIME_UNSET) {
