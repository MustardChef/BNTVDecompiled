...
public final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private long pendingResetPositionUs = C3282C.TIME_UNSET;
    private long length = -1;
    private long durationUs = C3282C.TIME_UNSET;
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        SeekMap seekMap;
        if (this.durationUs == C3282C.TIME_UNSET && (seekMap = this.seekMap) != null) {
    ...
    public void lambda$seekMap$1$ProgressiveMediaPeriod(SeekMap seekMap) {
        this.seekMap = this.icyHeaders == null ? seekMap : new SeekMap.Unseekable(C3282C.TIME_UNSET);
        this.durationUs = seekMap.getDurationUs();
        boolean z = this.length == -1 && seekMap.getDurationUs() == C3282C.TIME_UNSET;
        this.isLive = z;
        this.dataType = z ? 7 : 1;
    ...
    public void maybeFinishPrepare() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            trackGroupArr[i] = new TrackGroup(format.copyWithCryptoType(this.drmSessionManager.getCryptoType(format)));
        }
    ...
    private void startLoading() {
        ...
        if (this.prepared) {
            ...
            if (j != C3282C.TIME_UNSET && this.pendingResetPositionUs > j) {
                this.loadingFinished = true;
                this.pendingResetPositionUs = C3282C.TIME_UNSET;
                return;
            }
    ...
    private boolean configureRetry(ExtractingLoadable extractingLoadable, int i) {
        SeekMap seekMap;
        if (this.length != -1 || ((seekMap = this.seekMap) != null && seekMap.getDurationUs() != C3282C.TIME_UNSET)) {
    ...
    private boolean isPendingReset() {
        return this.pendingResetPositionUs != C3282C.TIME_UNSET;
    }
    ...
    public static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f9684id == trackId.f9684id && this.isIcyTrack == trackId.isIcyTrack;
        }

        public int hashCode() {
            return (this.f9684id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
