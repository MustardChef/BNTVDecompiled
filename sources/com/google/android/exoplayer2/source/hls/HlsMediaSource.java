...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    private SinglePeriodTimeline createTimelineForLive(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        ...
        return new SinglePeriodTimeline(j, j2, C3282C.TIME_UNSET, j3, hlsMediaPlaylist.durationUs, initialStartTimeUs, getLiveWindowDefaultStartPositionUs(hlsMediaPlaylist, liveEdgeOffsetUs), true, !hlsMediaPlaylist.hasEndTag, hlsMediaPlaylist.playlistType == 2 && hlsMediaPlaylist.hasPositiveStartOffset, hlsManifest, this.mediaItem, this.liveConfiguration);
    }
    ...
    private SinglePeriodTimeline createTimelineForOnDemand(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        long j3;
        if (hlsMediaPlaylist.startOffsetUs == C3282C.TIME_UNSET || hlsMediaPlaylist.segments.isEmpty()) {
            j3 = 0;
        ...
        return new SinglePeriodTimeline(j, j2, C3282C.TIME_UNSET, hlsMediaPlaylist.durationUs, hlsMediaPlaylist.durationUs, 0L, j3, true, false, true, hlsManifest, this.mediaItem, null);
    }
    ...
    private long getLiveWindowDefaultStartPositionUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        long msToUs;
        if (hlsMediaPlaylist.startOffsetUs != C3282C.TIME_UNSET) {
    ...
    private void maybeUpdateLiveConfiguration(long j) {
        ...
        if (usToMs != this.liveConfiguration.targetOffsetMs) {
            this.liveConfiguration = this.liveConfiguration.buildUpon().setTargetOffsetMs(usToMs).build();
        }
    }
    ...
    private static long getTargetLiveOffsetUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        ...
        } else if (serverControl.partHoldBackUs != C3282C.TIME_UNSET && hlsMediaPlaylist.partTargetDurationUs != C3282C.TIME_UNSET) {
            j2 = serverControl.partHoldBackUs;
        } else if (serverControl.holdBackUs != C3282C.TIME_UNSET) {
