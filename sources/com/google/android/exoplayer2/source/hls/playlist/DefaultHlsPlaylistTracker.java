...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public static final HlsPlaylistTracker.Factory FACTORY = $$Lambda$v4Cu38iwTNBS0lObDF_BajWNhwg.INSTANCE;
    ...
    public DefaultHlsPlaylistTracker(HlsDataSourceFactory hlsDataSourceFactory, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistParserFactory hlsPlaylistParserFactory, double d) {
        ...
        this.initialStartTimeUs = C3282C.TIME_UNSET;
    }
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
        ...
        boolean z = retryDelayMsFor == C3282C.TIME_UNSET;
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
            ...
            if (elapsedRealtime < this.earliestNextLoadTimeMs) {
                ...
                DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable() { // from class: com.google.android.exoplayer2.source.hls.playlist.-$$Lambda$DefaultHlsPlaylistTracker$MediaPlaylistBundle$1BVYirnNpLtBVQiVEwnNBozuq7k
                    ...
                    public final void run() {
                        DefaultHlsPlaylistTracker.MediaPlaylistBundle.this.m392xca8f1aa6(uri);
                    }
        ...
        public /* synthetic */ void m392xca8f1aa6(Uri uri) {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (latestPlaylistSnapshot != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + hlsMediaPlaylist.segments.size() < this.playlistSnapshot.mediaSequence) {
                    ...
                    playlistStuckException = ((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) Util.usToMs(this.playlistSnapshot.targetDurationUs)) * DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient ? new HlsPlaylistTracker.PlaylistStuckException(this.playlistUrl) : null;
                    z = false;
                }
            ...
            if (!((this.playlistSnapshot.partTargetDurationUs != C3282C.TIME_UNSET || this.playlistUrl.equals(DefaultHlsPlaylistTracker.this.primaryMediaPlaylistUrl)) ? true : true) || this.playlistSnapshot.hasEndTag) {
                return;
            }
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (hlsMediaPlaylist == null || (hlsMediaPlaylist.serverControl.skipUntilUs == C3282C.TIME_UNSET && !this.playlistSnapshot.serverControl.canBlockReload)) {
            ...
            if (this.playlistSnapshot.serverControl.canBlockReload) {
                ...
                if (this.playlistSnapshot.partTargetDurationUs != C3282C.TIME_UNSET) {
            ...
            if (this.playlistSnapshot.serverControl.skipUntilUs != C3282C.TIME_UNSET) {
