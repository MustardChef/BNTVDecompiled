...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final AdPlaybackState NONE = new AdPlaybackState(null, new AdGroup[0], 0, C3282C.TIME_UNSET, 0);
    private static final AdGroup REMOVED_AD_GROUP = new AdGroup(0).withAdCount(0);
    public static final Bundleable.Creator<AdPlaybackState> CREATOR = $$Lambda$AdPlaybackState$v7MSQh9nkbSNgVVbdfE7aSUxQOQ.INSTANCE;
    ...
    public static final class AdGroup implements Bundleable {
        public static final Bundleable.Creator<AdGroup> CREATOR = $$Lambda$AdPlaybackState$AdGroup$C29JxihoVs9kyxHjAM5HCSTvU.INSTANCE;
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, (long) C3282C.TIME_UNSET);
            return copyOf;
        }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, createEmptyAdGroups(jArr), 0L, C3282C.TIME_UNSET, 0);
    }
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        return j3 == Long.MIN_VALUE ? j2 == C3282C.TIME_UNSET || j < j2 : j < j3;
    }
    ...
    public static AdPlaybackState fromBundle(Bundle bundle) {
        ...
        return new AdPlaybackState(null, adGroupArr, bundle.getLong(keyForField(2), 0L), bundle.getLong(keyForField(3), C3282C.TIME_UNSET), bundle.getInt(keyForField(4)));
    }
