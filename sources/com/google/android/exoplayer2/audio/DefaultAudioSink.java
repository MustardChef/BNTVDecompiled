...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            intValue = i7;
            i3 = Util.getPcmFrameSize(i7, audioFormat.channelCount);
            i5 = 0;
        } else {
        ...
        if (intValue == 0) {
            ...
            Configuration configuration = new Configuration(format, i2, i5, i3, i4, intValue2, intValue, i, this.enableAudioTrackPlaybackParams, audioProcessorArr);
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.audioTrackPositionTracker.mayHandleBuffer(getWrittenFrames())) {
            ...
            if (!this.inputBuffer.hasRemaining()) {
                ...
                Log.m379w(TAG, "Resetting stalled audio track");
                flush();
                return true;
            } else {
                return false;
    ...
    */
    ...
    private void setAudioTrackPlaybackParametersV23(PlaybackParameters playbackParameters) {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m378w(TAG, "Failed to set playback params", e);
            }
    ...
    private void setAudioProcessorPlaybackParametersAndSkipSilence(PlaybackParameters playbackParameters, boolean z) {
        ...
        MediaPositionParameters mediaPositionParameters2 = new MediaPositionParameters(playbackParameters, z, C3282C.TIME_UNSET, C3282C.TIME_UNSET);
        if (isAudioTrackInitialized()) {
            ...
            if (audioCapabilities.supportsEncoding(encoding)) {
                if (encoding == 18) {
                    if (Util.SDK_INT >= 29 && (i = getMaxSupportedChannelCountForPassthroughV29(18, format.sampleRate)) == 0) {
                        Log.m379w(TAG, "E-AC3 JOC encoding supported but no channel count supported");
                        return null;
                    }
                } else {
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            Log.m379w(DefaultAudioSink.TAG, sb2);
        }
        ...
        public void onInvalidLatency(long j) {
            ...
            sb.append(j);
            Log.m379w(DefaultAudioSink.TAG, sb.toString());
        }
