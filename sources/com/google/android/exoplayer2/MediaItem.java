...
public final class MediaItem implements Bundleable {
    ...
    public static final Bundleable.Creator<MediaItem> CREATOR = $$Lambda$MediaItem$jV0pUJBLiCLPyDyDvfHo6BdOSE.INSTANCE;
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.subtitleConfigurations = ImmutableList.m295of();
        ...
        public Builder setSubtitles(List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m295of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder(UUID uuid) {
                this.scheme = uuid;
                this.licenseRequestHeaders = ImmutableMap.m276of();
                this.forcedSessionTrackTypes = ImmutableList.m295of();
            }
            ...
            public Builder forceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList m295of;
                if (z) {
                    m295of = ImmutableList.m293of(2, 1);
                } else {
                    m295of = ImmutableList.m295of();
                }
                setForcedSessionTrackTypes(m295of);
                return this;
            }
    ...
    public static final class LiveConfiguration implements Bundleable {
        ...
        public static final Bundleable.Creator<LiveConfiguration> CREATOR = C3280x374bbfb4.INSTANCE;
        ...
        public static final class Builder {
            ...
            public Builder() {
                this.targetOffsetMs = C3282C.TIME_UNSET;
                this.minOffsetMs = C3282C.TIME_UNSET;
                this.maxOffsetMs = C3282C.TIME_UNSET;
        ...
        public static /* synthetic */ LiveConfiguration lambda$static$0(Bundle bundle) {
            return new LiveConfiguration(bundle.getLong(keyForField(0), C3282C.TIME_UNSET), bundle.getLong(keyForField(1), C3282C.TIME_UNSET), bundle.getLong(keyForField(2), C3282C.TIME_UNSET), bundle.getFloat(keyForField(3), -3.4028235E38f), bundle.getFloat(keyForField(4), -3.4028235E38f));
        }
    ...
    public static class SubtitleConfiguration {
        ...
        private SubtitleConfiguration(Uri uri, String str, String str2, int i, int i2, String str3) {
            this.uri = uri;
            this.mimeType = str;
            this.language = str2;
            this.selectionFlags = i;
    ...
    public static class ClippingConfiguration implements Bundleable {
        ...
        public static final Bundleable.Creator<ClippingProperties> CREATOR = C3279xde3ef026.INSTANCE;
