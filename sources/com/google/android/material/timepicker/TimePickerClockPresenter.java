...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_VALUES = {"12", "1", ExifInterface.GPS_MEASUREMENT_2D, "3", "4", "5", "6", "7", "8", "9", "10", "11"};
    ...
    void setSelection(int i, boolean z) {
        ...
        this.timePickerView.setValues(z2 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z2 ? C3633R.string.material_minute_suffix : C3633R.string.material_hour_suffix);
        ...
        timePickerView.setMinuteHourDelegate(new ClickActionDelegate(timePickerView.getContext(), C3633R.string.material_hour_selection));
        TimePickerView timePickerView2 = this.timePickerView;
        timePickerView2.setHourClickDelegate(new ClickActionDelegate(timePickerView2.getContext(), C3633R.string.material_minute_selection));
    }
