...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) from.inflate(C3633R.C3638layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(C3633R.C3638layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C3633R.C3636id.material_label);
