...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C3633R.C3636id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C3633R.C3636id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C3633R.C3636id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C3633R.C3636id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C3633R.C3636id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C3633R.C3636id.navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C3633R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C3633R.attr.motionDurationLong1, getResources().getInteger(C3633R.integer.material_motion_duration_long_1)));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C3633R.string.item_view_role_description));
    }
    ...
    protected int getItemBackgroundResId() {
        return C3633R.C3635drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C3633R.dimen.mtrl_navigation_bar_item_default_margin;
    }
