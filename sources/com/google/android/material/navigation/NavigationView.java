...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private static final int DEF_STYLE_RES = C3633R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3633R.attr.navigationViewStyle);
    }
    ...
    */
    ...
    private boolean hasShapeAppearance(TintTypedArray tintTypedArray) {
        return tintTypedArray.hasValue(C3633R.styleable.NavigationView_itemShapeAppearance) || tintTypedArray.hasValue(C3633R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private final Drawable createDefaultItemBackground(TintTypedArray tintTypedArray) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), tintTypedArray.getResourceId(C3633R.styleable.NavigationView_itemShapeAppearance, 0), tintTypedArray.getResourceId(C3633R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), tintTypedArray, C3633R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable((Drawable) materialShapeDrawable, tintTypedArray.getDimensionPixelSize(C3633R.styleable.NavigationView_itemShapeInsetStart, 0), tintTypedArray.getDimensionPixelSize(C3633R.styleable.NavigationView_itemShapeInsetTop, 0), tintTypedArray.getDimensionPixelSize(C3633R.styleable.NavigationView_itemShapeInsetEnd, 0), tintTypedArray.getDimensionPixelSize(C3633R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private ColorStateList createDefaultColorStateList(int i) {
        ...
        if (getContext().getTheme().resolveAttribute(i, typedValue, true)) {
            ...
            if (getContext().getTheme().resolveAttribute(C0067R.attr.colorPrimary, typedValue, true)) {
