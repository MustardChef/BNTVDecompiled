...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C3633R.attr.motionDurationLong1, getResources().getInteger(C3633R.integer.material_motion_duration_long_1)));
        autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C3633R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
