...
public class TabLayout extends HorizontalScrollView {
    ...
    ViewPager viewPager;
    private static final int DEF_STYLE_RES = C3633R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3633R.attr.tabStyle);
    }
    ...
    */
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f9747id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f9747id);
        }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C3633R.C3638layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C3633R.C3638layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
