...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f9745x = f;
        pathLineOperation.f9746y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f9746y - this.startY, this.operation.f9745x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f9746y - this.startY) / (this.operation.f9745x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        private float f9745x;

        /* renamed from: y */
        private float f9746y;
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f9745x, this.f9746y);
