...
public final class zzmh implements zzme {
    ...
    static {
        ...
        zzu = zzdmVar.zza("measurement.upload.initial_upload_delay_time", C3282C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        zzv = zzdmVar.zza("measurement.upload.interval", 3600000L);
        zzw = zzdmVar.zza("measurement.upload.max_bundle_size", 65536L);
        ...
        zzaf = zzdmVar.zza("measurement.upload.max_batch_size", 65536L);
        zzag = zzdmVar.zza("measurement.upload.retry_count", 6L);
        zzah = zzdmVar.zza("measurement.upload.retry_time", Constants.TIME_30MIN_TO_SHOW_ADS);
        zzai = zzdmVar.zza("measurement.upload.url", "https://app-measurement.com/a");
