...
public final class zzem<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public zzem() {
        ...
        this.zzf = zzfz.zza(3, 1, LockFreeTaskQueueCore.MAX_CAPACITY_MASK);
    }
    ...
    public final V put(@NullableDecl K k, @NullableDecl V v) {
        ...
        if (zza2 != 0) {
            ...
            while (true) {
                ...
                if (i10 != 0) {
                    ...
                    zzi = zza(zzi, zzex.zzb(zzi), zza, i2);
                } else {
                    iArr[i8] = zzex.zza(i9, i3, zzi);
                }
            }
        } else if (i3 > zzi) {
            zzi = zza(zzi, zzex.zzb(zzi), zza, i2);
        ...
        this.zza[i2] = zzex.zza(zza, 0, zzi);
        this.zzb[i2] = k;
        this.zzc[i2] = v;
        this.zzg = i3;
        zzc();
    ...
    private final int zza(int i, int i2, int i3, int i4) {
        Object zza = zzex.zza(i2);
        int i5 = i2 - 1;
        if (i4 != 0) {
            zzex.zza(zza, i3 & i5, i4 + 1);
        }
        Object obj = this.zze;
        int[] iArr = this.zza;
        for (int i6 = 0; i6 <= i; i6++) {
            int zza2 = zzex.zza(obj, i6);
            while (zza2 != 0) {
                int i7 = zza2 - 1;
                int i8 = iArr[i7];
                int i9 = ((~i) & i8) | i6;
                int i10 = i9 & i5;
                int zza3 = zzex.zza(zza, i10);
                zzex.zza(zza, i10, zza2);
                iArr[i7] = zzex.zza(i9, zza3, i5);
                zza2 = i8 & i;
            }
        }
        this.zze = zza;
    ...
    public final int zza(@NullableDecl Object obj) {
        ...
        int zzi = zzi();
        int zza2 = zzex.zza(this.zze, zza & zzi);
        if (zza2 == 0) {
            return -1;
        }
        int i = ~zzi;
    ...
    public final Object zzb(@NullableDecl Object obj) {
        ...
        int zzi = zzi();
        int zza = zzex.zza(obj, null, zzi, this.zze, this.zza, this.zzb, null);
        if (zza == -1) {
            return zzd;
        }
    ...
    public final void zza(int i, int i2) {
        ...
        if (i < size) {
            ...
            iArr[i] = iArr[size];
            iArr[size] = 0;
            int zza = zzez.zza(obj) & i2;
            int zza2 = zzex.zza(this.zze, zza);
            int i3 = size + 1;
            if (zza2 == i3) {
                zzex.zza(this.zze, zza, i + 1);
                return;
            }
            while (true) {
                int i4 = zza2 - 1;
