...
public final class zzsn extends zzun<Void, zzg> {
    ...
    public final TaskApiCall<zztc, Void> zzb() {
        return TaskApiCall.builder().run(new RemoteCall(this) { // from class: com.google.android.gms.internal.firebase-auth-api.zzsm
    ...
    public final /* synthetic */ void zzd(zztc zztcVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zztcVar.zzo().zzg(new zzlg(this.zze.zzg(), this.zza), this.zzc);
    }
}
