...
public final class zzsx extends zzun<Void, PhoneAuthProvider.OnVerificationStateChangedCallbacks> {
    private final zzmk zza;

    public zzsx(zzwt zzwtVar) {
        super(8);
        Preconditions.checkNotNull(zzwtVar);
        this.zza = new zzmk(zzwtVar);
    }
    ...
    public final TaskApiCall<zztc, Void> zzb() {
        return TaskApiCall.builder().run(new RemoteCall(this) { // from class: com.google.android.gms.internal.firebase-auth-api.zzsw
    ...
    public final /* synthetic */ void zzd(zztc zztcVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zztcVar.zzo().zzu(this.zza, this.zzc);
    }
}
