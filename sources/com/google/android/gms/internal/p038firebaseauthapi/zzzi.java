...
final class zzzi extends zzxv<Float> implements RandomAccess, zzzt, zzaay {
    ...
    static {
        zzzi zzziVar = new zzzi(new float[0], 0);
        zza = zzziVar;
        zzziVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzziVar.zzb, 0, this.zzb, this.zzc, zzziVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzziVar.zzc) {
            return false;
        }
        float[] fArr = zzziVar.zzb;
