...
public final class zzqj extends zzun<AuthResult, zzg> {
    ...
    public final TaskApiCall<zztc, AuthResult> zzb() {
        return TaskApiCall.builder().run(new RemoteCall(this) { // from class: com.google.android.gms.internal.firebase-auth-api.zzqi
    ...
    public final /* synthetic */ void zzd(zztc zztcVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zztcVar.zzo().zzk(new zzly(this.zza.zzb(), this.zza.zzc(), this.zze.zzg()), this.zzc);
    }
}
