...
interface zzabc {
    ...
    <T> void zzG(List<T> list, zzabd<T> zzabdVar, zzzb zzzbVar) throws IOException;

    @Deprecated
    <T> void zzH(List<T> list, zzabd<T> zzabdVar, zzzb zzzbVar) throws IOException;

    void zzI(List<zzym> list) throws IOException;
    ...
    <T> T zzo(zzabd<T> zzabdVar, zzzb zzzbVar) throws IOException;

    @Deprecated
    <T> T zzp(zzabd<T> zzabdVar, zzzb zzzbVar) throws IOException;

    zzym zzq() throws IOException;
