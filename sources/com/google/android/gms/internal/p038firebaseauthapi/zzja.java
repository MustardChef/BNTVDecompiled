...
public final class zzja extends zzzo<zzja, zziz> implements zzaas {
    ...
    static {
        ...
        zzf = zzjaVar;
        zzzo.zzy(zzja.class, zzjaVar);
    }

    private zzja() {
    }

    public static zzja zzc(zzym zzymVar, zzzb zzzbVar) throws zzzw {
        return (zzja) zzzo.zzE(zzf, zzymVar, zzzbVar);
    }
    ...
    public static /* synthetic */ void zzg(zzja zzjaVar, zzym zzymVar) {
        zzymVar.getClass();
        zzjaVar.zze = zzymVar;
    }
