...
public final class zzod extends zzof {
    private final byte[] zzb;
    private final int zzc;
    private int zzd;

    @Override // com.google.android.gms.internal.cast.zzof
    ...
    @Override // com.google.android.gms.internal.cast.zzof
    public final void zzi(int i, zzny zznyVar) throws IOException {
        zzl((i << 3) | 2);
        zzl(zznyVar.zzc());
        zznyVar.zzf(this);
    }
    ...
    public final void zzl(int i) throws IOException {
        ...
        while ((i & (-128)) != 0) {
            try {
                ...
                throw new zzoe(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
            }
        }
        byte[] bArr2 = this.zzb;
        int i4 = this.zzd;
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 != zzw) {
                ...
                byte[] bArr = this.zzb;
                int i2 = this.zzd;
                this.zzd = zzrl.zzd(str, bArr, i2, this.zzc - i2);
                return;
            }
            int i3 = i + zzw2;
            this.zzd = i3;
            int zzd = zzrl.zzd(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((zzd - i) - zzw2);
            this.zzd = zzd;
        } catch (zzrk e) {
    ...
    public final void zzp(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzoe(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzn(long j) throws IOException {
        ...
        while ((j & (-128)) != 0) {
            ...
            int i3 = this.zzd;
            this.zzd = i3 + 1;
            zzrh.zzp(bArr3, i3, (byte) ((((int) j) & 127) | 128));
            j >>>= 7;
        }
        byte[] bArr4 = this.zzb;
        int i4 = this.zzd;
        this.zzd = i4 + 1;
        zzrh.zzp(bArr4, i4, (byte) j);
    }
}
