...
public abstract class zzny implements Iterable<Byte>, Serializable {
    public static final zzny zzb = new zznw(zzpb.zzc);
    private static final Comparator<zzny> zzc;
    ...
    public static zzny zzj(String str) {
        return new zznw(str.getBytes(zzpb.zza));
    }
    ...
    public final String toString() {
        ...
        objArr[2] = zzc() <= 50 ? zzqv.zza(this) : String.valueOf(zzqv.zza(zze(0, 47))).concat("...");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public abstract void zzf(zznp zznpVar) throws IOException;
