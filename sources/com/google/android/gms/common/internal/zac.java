...
import com.google.android.gms.common.C3622R;
...
public final class zac {
    ...
    public static String zaa(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C3609R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C3609R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C3609R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    public static String zab(Context context, int i) {
        ...
        return zaa2 == null ? context.getResources().getString(C3609R.string.common_google_play_services_notification_ticker) : zaa2;
    }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i != 1) {
            if (i == 2) {
                return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C3609R.string.common_google_play_services_wear_update_text) : resources.getString(C3609R.string.common_google_play_services_update_text, zaf);
            } else if (i != 3) {
                if (i != 5) {
                    if (i != 7) {
                        if (i != 9) {
                            ...
                            switch (i) {
                                ...
                                case 18:
                                    return resources.getString(C3609R.string.common_google_play_services_updating_text, zaf);
                                default:
                                    return resources.getString(C3622R.string.common_google_play_services_unknown_issue, zaf);
                            }
                        }
                        return resources.getString(C3609R.string.common_google_play_services_unsupported_text, zaf);
                    }
                ...
                return resources.getString(C3609R.string.common_google_play_services_enable_text, zaf);
            }
        }
        return resources.getString(C3609R.string.common_google_play_services_install_text, zaf);
    }
    ...
    public static String zae(Context context, int i) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return resources.getString(C3609R.string.common_google_play_services_enable_button);
                }
                return resources.getString(17039370);
            }
            return resources.getString(C3609R.string.common_google_play_services_update_button);
        }
        return resources.getString(C3609R.string.common_google_play_services_install_button);
    }
    ...
    public static String zag(Context context) {
        return context.getResources().getString(C3609R.string.common_google_play_services_notification_channel_name);
    }
    ...
    private static String zah(Context context, String str, String str2) {
        ...
        if (zai == null) {
            zai = resources.getString(C3622R.string.common_google_play_services_unknown_issue);
        }
