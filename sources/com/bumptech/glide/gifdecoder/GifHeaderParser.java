...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f2730ix = readShort();
        this.header.currentFrame.f2731iy = readShort();
        this.header.currentFrame.f2729iw = readShort();
        this.header.currentFrame.f2728ih = readShort();
        int read = read();
