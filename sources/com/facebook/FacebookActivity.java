...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C2023R.C2028layout.com_facebook_activity_layout);
    ...
    protected Fragment getFragment() {
        ...
        if (findFragmentByTag == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                supportFragmentManager.beginTransaction().add(C2023R.C2026id.com_facebook_fragment_container, referralFragment, FRAGMENT_TAG).commit();
                return referralFragment;
            } else {
                LoginFragment loginFragment = new LoginFragment();
                loginFragment.setRetainInstance(true);
                supportFragmentManager.beginTransaction().add(C2023R.C2026id.com_facebook_fragment_container, loginFragment, FRAGMENT_TAG).commit();
