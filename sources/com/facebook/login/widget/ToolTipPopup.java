...
public class ToolTipPopup {
    ...
    public void show() {
        ...
        try {
            if (this.mAnchorViewRef.get() != null) {
                ...
                ((TextView) popupContentView.findViewById(C2135R.C2138id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
                if (this.mStyle == Style.BLUE) {
                    this.mPopupContent.bodyFrame.setBackgroundResource(C2135R.C2137drawable.com_facebook_tooltip_blue_background);
                    this.mPopupContent.bottomArrow.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_blue_bottomnub);
                    this.mPopupContent.topArrow.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_blue_topnub);
                    this.mPopupContent.xOut.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_blue_xout);
                } else {
                    this.mPopupContent.bodyFrame.setBackgroundResource(C2135R.C2137drawable.com_facebook_tooltip_black_background);
                    this.mPopupContent.bottomArrow.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_black_bottomnub);
                    this.mPopupContent.topArrow.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_black_topnub);
                    this.mPopupContent.xOut.setImageResource(C2135R.C2137drawable.com_facebook_tooltip_black_xout);
                }
    ...
    public class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C2135R.C2140layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C2135R.C2138id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C2135R.C2138id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C2135R.C2138id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C2135R.C2138id.com_facebook_button_xout);
        }
