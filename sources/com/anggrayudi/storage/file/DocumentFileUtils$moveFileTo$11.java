...
public final class DocumentFileUtils$moveFileTo$11 extends Lambda implements Function2<InputStream, OutputStream, Unit> {
    ...
    public final void invoke2(InputStream inputStream, OutputStream outputStream) {
        ...
        DocumentFileExt.copyFileStream(this.$this_moveFileTo, inputStream, outputStream, this.$targetFile, this.$watchProgress, this.$reportInterval, true, this.$callback);
    }
}
