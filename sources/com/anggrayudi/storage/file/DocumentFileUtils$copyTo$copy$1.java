...
public final class DocumentFileUtils$copyTo$copy$1 extends Lambda implements Function2<DocumentFile, DocumentFile, Unit> {
    ...
    public DocumentFileUtils$copyTo$copy$1(Context context, MultipleFileCallback multipleFileCallback, Ref.IntRef intRef, boolean z, byte[] bArr, Ref.LongRef longRef, Ref.IntRef intRef2) {
        super(2);
    ...
    /* renamed from: com.anggrayudi.storage.file.DocumentFileUtils$copyTo$copy$1$1 */
    /* loaded from: classes.dex */
    public static final class C11231 extends Lambda implements Function2<InputStream, OutputStream, Unit> {
        final /* synthetic */ byte[] $buffer;
        final /* synthetic */ Ref.LongRef $bytesMoved;
        final /* synthetic */ Ref.IntRef $writeSpeed;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C11231(byte[] bArr, Ref.LongRef longRef, Ref.IntRef intRef) {
            super(2);
            this.$buffer = bArr;
            this.$bytesMoved = longRef;
    ...
    public final void invoke2(DocumentFile sourceFile, DocumentFile destFile) {
        ...
        DocumentFileExt.createFileStreams(this.$context, sourceFile, destFile, this.$callback, new C11231(this.$buffer, this.$bytesMoved, this.$writeSpeed));
