...
@DebugMetadata(m99c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2", m98f = "DocumentFileExt.kt", m97i = {}, m96l = {58}, m95m = "invokeSuspend", m94n = {}, m93s = {})
...
public final class DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Long>, Object> {
    ...
    @DebugMetadata(m99c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2$1", m98f = "DocumentFileExt.kt", m97i = {}, m96l = {}, m95m = "invokeSuspend", m94n = {}, m93s = {})
    /* renamed from: com.anggrayudi.storage.file.DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2$1 */
    /* loaded from: classes.dex */
    public static final class C10881 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10881(CancellableContinuation cancellableContinuation, Continuation continuation, FileCallback fileCallback, DocumentFile documentFile, Thread thread) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C10881(this.$it, continuation, this.$callback$inlined, this.$this_copyFileTo$inlined, this.$thread$inlined);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        BuildersKt__Builders_commonKt.launch$default(coroutineScope2, Dispatchers.getMain(), null, new C10881(cancellableContinuationImpl, null, this.$callback$inlined, this.$this_copyFileTo$inlined, this.$thread$inlined), 2, null);
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbes.probeCoroutineSuspended(documentFileUtils$copyFileTo$$inlined$awaitUiResult$2);
        }
