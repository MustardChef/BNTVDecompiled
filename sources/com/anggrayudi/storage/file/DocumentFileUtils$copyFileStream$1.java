...
public final class DocumentFileUtils$copyFileStream$1 extends Lambda implements Functions<Unit> {
    ...
    public DocumentFileUtils$copyFileStream$1(Ref.LongRef longRef, long j, Ref.IntRef intRef, FileCallback fileCallback) {
        super(0);
    ...
    public final void invoke2() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.$callback.getUiScope(), Dispatchers.getMain(), null, new DocumentFileUtils$copyFileStream$1$invoke$$inlined$postToUi$1(null, this.$callback, report), 2, null);
