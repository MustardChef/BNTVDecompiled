...
public final class LiveTvSearchResponse implements SearchResponse {
    ...
    public final LiveTvSearchResponse copy(@JsonProperty("name") String name, @JsonProperty("url") String url, @JsonProperty("apiName") String apiName, @JsonProperty("type") TvType tvType, @JsonProperty("posterUrl") String str, @JsonProperty("year") Integer num, @JsonProperty("id") Integer num2, @JsonProperty("quality") SearchQuality searchQuality, @JsonProperty("posterHeaders") Map<String, String> map) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(apiName, "apiName");
        return new LiveTvSearchResponse(name, url, apiName, tvType, str, num, num2, searchQuality, map);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LiveTvSearchResponse) {
            LiveTvSearchResponse liveTvSearchResponse = (LiveTvSearchResponse) obj;
            return Intrinsics.areEqual(getName(), liveTvSearchResponse.getName()) && Intrinsics.areEqual(getUrl(), liveTvSearchResponse.getUrl()) && Intrinsics.areEqual(getApiName(), liveTvSearchResponse.getApiName()) && getType() == liveTvSearchResponse.getType() && Intrinsics.areEqual(getPosterUrl(), liveTvSearchResponse.getPosterUrl()) && Intrinsics.areEqual(this.year, liveTvSearchResponse.year) && Intrinsics.areEqual(getId(), liveTvSearchResponse.getId()) && getQuality() == liveTvSearchResponse.getQuality() && Intrinsics.areEqual(getPosterHeaders(), liveTvSearchResponse.getPosterHeaders());
        }
        return false;
    }
    ...
    public String toString() {
        return "LiveTvSearchResponse(name=" + getName() + ", url=" + getUrl() + ", apiName=" + getApiName() + ", type=" + getType() + ", posterUrl=" + getPosterUrl() + ", year=" + this.year + ", id=" + getId() + ", quality=" + getQuality() + ", posterHeaders=" + getPosterHeaders() + ')';
    }

    public LiveTvSearchResponse(@JsonProperty("name") String name, @JsonProperty("url") String url, @JsonProperty("apiName") String apiName, @JsonProperty("type") TvType tvType, @JsonProperty("posterUrl") String str, @JsonProperty("year") Integer num, @JsonProperty("id") Integer num2, @JsonProperty("quality") SearchQuality searchQuality, @JsonProperty("posterHeaders") Map<String, String> map) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(apiName, "apiName");
        this.name = name;
    ...
    public /* synthetic */ LiveTvSearchResponse(String str, String str2, String str3, TvType tvType, String str4, Integer num, Integer num2, SearchQuality searchQuality, Map map, int i, DefaultConstructorMarker defaultConstructorMarker) {
