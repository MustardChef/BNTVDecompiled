...
/* renamed from: com.lagradost.cloudstream3.ui.search.SearchHistoryDiffCallback */
/* loaded from: classes4.dex */
public final class SearchHistoryDiffCallback extends DiffUtil.Callback {
    private final List<SearchHistoryItem> newList;
    private final List<SearchHistoryItem> oldList;

    public SearchHistoryDiffCallback(List<SearchHistoryItem> oldList, List<SearchHistoryItem> newList) {
    ...
    public boolean areItemsTheSame(int i, int i2) {
        return Intrinsics.areEqual(this.oldList.get(i).getSearchText(), this.newList.get(i2).getSearchText());
    }
