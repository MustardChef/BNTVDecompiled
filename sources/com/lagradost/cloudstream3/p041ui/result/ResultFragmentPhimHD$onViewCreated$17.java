...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$17 */
/* loaded from: classes4.dex */
final class ResultFragmentPhimHD$onViewCreated$17 extends Lambda implements Function1<Resource<? extends SyncAPI.SyncResult>, Unit> {
    final /* synthetic */ Ref.IntRef $currentSyncProgress;
    final /* synthetic */ ResultFragmentPhimHD this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ResultFragmentPhimHD$onViewCreated$17(ResultFragmentPhimHD resultFragmentPhimHD, Ref.IntRef intRef) {
        super(1);
    ...
    public final void invoke2(Resource<SyncAPI.SyncResult> meta) {
        ...
        if (meta instanceof Resource.Success) {
            ...
            ResultFragmentPhimHD.onViewCreated$setSyncMaxEpisodes(this.this$0, syncResult.getTotalEpisodes());
