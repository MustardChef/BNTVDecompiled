...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$adapter$1 */
/* loaded from: classes4.dex */
final class ResultFragmentTV$onViewCreated$adapter$1 extends Lambda implements Function1<EpisodeClickEvent, Unit> {
    ...
    public ResultFragmentTV$onViewCreated$adapter$1(ResultFragmentTV resultFragmentTV, String str, MainAPI mainAPI) {
        super(1);
    ...
    public final void invoke2(EpisodeClickEvent episodeClick) {
        ...
        ResultFragmentTV.onViewCreated$handleAction(this.this$0, this.$apiName, this.$api, episodeClick);
    }
}
