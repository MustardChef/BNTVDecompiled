...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$9 */
/* loaded from: classes4.dex */
final class ResultFragmentTV$onViewCreated$9 extends Lambda implements Function1<WatchType, Unit> {
    final /* synthetic */ ResultFragmentTV this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ResultFragmentTV$onViewCreated$9(ResultFragmentTV resultFragmentTV) {
        super(1);
    ...
    public final void invoke2(final WatchType watchType) {
        ...
        if (num != null) {
            ResultFragmentTV resultFragmentTV = this.this$0;
            ColorStateList valueOf = ColorStateList.valueOf(num.intValue());
            Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(it)");
            ExtendedFloatingActionButton extendedFloatingActionButton4 = (ExtendedFloatingActionButton) resultFragmentTV._$_findCachedViewById(C4761R.C4764id.result_bookmark_fab);
            if (extendedFloatingActionButton4 != null) {
                extendedFloatingActionButton4.setIconTint(valueOf);
            }
            ExtendedFloatingActionButton extendedFloatingActionButton5 = (ExtendedFloatingActionButton) resultFragmentTV._$_findCachedViewById(C4761R.C4764id.result_bookmark_fab);
        ...
        if (extendedFloatingActionButton6 != null) {
            ...
            extendedFloatingActionButton6.setOnClickListener(new View.OnClickListener() { // from class: com.lagradost.cloudstream3.ui.result.-$$Lambda$ResultFragmentTV$onViewCreated$9$RgavvDFtPAjgmoCzUTF2dbVokTo
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ResultFragmentTV$onViewCreated$9.m8857invoke$lambda2(ResultFragmentTV.this, watchType, view);
                }
            });
        }
    }
    ...
    public static final void m8857invoke$lambda2(ResultFragmentTV this$0, WatchType watchType, View view) {
        ...
        if (activity != null) {
            ...
            singleSelectionHelper.showBottomDialog(fragmentActivity, list, ordinal, string, false, ResultFragmentTV$onViewCreated$9$2$2.INSTANCE, new ResultFragmentTV$onViewCreated$9$2$3(this$0));
        }
    }
}
