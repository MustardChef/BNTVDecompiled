...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$19 */
/* loaded from: classes4.dex */
final class ResultFragmentTV$onViewCreated$19 extends Lambda implements Function1<List<? extends ResultEpisode>, Unit> {
    ...
    public ResultFragmentTV$onViewCreated$19(ResultFragmentTV resultFragmentTV, Integer num, Integer num2, String str, MainAPI mainAPI) {
        super(1);
    ...
    */
    public final void invoke2(final java.util.List<com.lagradost.cloudstream3.p041ui.result.ResultEpisode> r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.result.ResultFragmentTV$onViewCreated$19.invoke2(java.util.List):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-6$lambda-2  reason: not valid java name */
    public static final void m8840invoke$lambda6$lambda2(List episodeList, VideoDownloadHelper.ResumeWatching resume, ResultFragmentTV this$0, String apiName, MainAPI api, View view) {
        Object obj;
        boolean z;
        ...
        if (resultEpisode != null) {
            ResultFragmentTV.onViewCreated$handleAction(this$0, apiName, api, new EpisodeClickEvent(1, resultEpisode));
        }
    }
}
