...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$18 */
/* loaded from: classes4.dex */
final class ResultFragmentPhimHD$onViewCreated$18 extends Lambda implements Function1<Resource<? extends SyncAPI.SyncStatus>, Unit> {
    final /* synthetic */ Ref.IntRef $currentSyncProgress;
    final /* synthetic */ ResultFragmentPhimHD this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ResultFragmentPhimHD$onViewCreated$18(ResultFragmentPhimHD resultFragmentPhimHD, Ref.IntRef intRef) {
        super(1);
    ...
    public final void invoke2(Resource<SyncAPI.SyncStatus> resource) {
        ...
        if (resource instanceof Resource.Failure) {
            ...
            if (resource instanceof Resource.Loading) {
                ...
                if (maxEpisodes != null) {
                    ResultFragmentPhimHD.onViewCreated$setSyncMaxEpisodes(this.this$0, Integer.valueOf(maxEpisodes.intValue()));
                }
                ...
                ArchComponentExt.normalSafeApiCall(new C49322(this.this$0, syncStatus));
            }
            z = false;
        }
    ...
    /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$18$2 */
    /* loaded from: classes4.dex */
    public static final class C49322 extends Lambda implements Functions<Unit> {

        /* renamed from: $d */
        final /* synthetic */ SyncAPI.SyncStatus f10018$d;
        final /* synthetic */ ResultFragmentPhimHD this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C49322(ResultFragmentPhimHD resultFragmentPhimHD, SyncAPI.SyncStatus syncStatus) {
            super(0);
            this.this$0 = resultFragmentPhimHD;
            this.f10018$d = syncStatus;
        }
        ...
        public final Unit invoke() {
            ...
            if (context != null && (string = context.getString(R.string.sync_score_format)) != null) {
                ...
                Integer score = this.f10018$d.getScore();
