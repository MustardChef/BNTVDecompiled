...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$handleAction$1$4$1 */
/* loaded from: classes4.dex */
final class ResultFragmentPhimHD$onViewCreated$handleAction$1$4$1 extends Lambda implements Function1<ExtractorLink, Unit> {
    final /* synthetic */ FragmentActivity $act;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ResultFragmentPhimHD$onViewCreated$handleAction$1$4$1(FragmentActivity fragmentActivity) {
        super(1);
