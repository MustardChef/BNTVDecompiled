...
/* renamed from: com.lagradost.cloudstream3.ui.subtitles.ChromecastSubtitlesFragment$onViewCreated$3$3 */
/* loaded from: classes4.dex */
public final class ChromecastSubtitlesFragment$onViewCreated$3$3 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ List<Tuples<Integer, String>> $edgeTypes;
    final /* synthetic */ View $textView;
    final /* synthetic */ ChromecastSubtitlesFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChromecastSubtitlesFragment$onViewCreated$3$3(ChromecastSubtitlesFragment chromecastSubtitlesFragment, List<Tuples<Integer, String>> list, View view) {
        super(1);
    ...
    public final void invoke(int i) {
        ...
        List<Tuples<Integer, String>> list = this.$edgeTypes;
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list, 10));
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(Integer.valueOf(((Number) ((Tuples) it.next()).getFirst()).intValue()));
        }
        saveChromeCaptionStyle.setEdgeType(((Number) arrayList.get(i)).intValue());
