...
/* renamed from: com.lagradost.cloudstream3.ui.download.EasyDownloadButton$setUpButton$1 */
/* loaded from: classes3.dex */
public final class EasyDownloadButton$setUpButton$1 extends Lambda implements Function1<Tuples<? extends Integer, ? extends String>, Unit> {
    final /* synthetic */ ImageView $downloadImage;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EasyDownloadButton$setUpButton$1(ImageView imageView) {
        super(1);
    ...
    public final void invoke2(Tuples<Integer, String> it) {
        ...
        this.$downloadImage.setImageResource(it.getFirst().intValue());
    }
}
