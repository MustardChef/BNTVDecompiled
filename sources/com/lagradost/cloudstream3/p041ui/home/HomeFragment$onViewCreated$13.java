...
/* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$onViewCreated$13 */
/* loaded from: classes3.dex */
final class HomeFragment$onViewCreated$13 extends Lambda implements Function1<SearchClickCallback, Unit> {
    ...
    /* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$onViewCreated$13$1 */
    /* loaded from: classes3.dex */
    public static final class C48601 extends Lambda implements Function1<Tuples<? extends Boolean, ? extends Integer>, Unit> {
        final /* synthetic */ SearchClickCallback $callback;
        final /* synthetic */ HomeFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C48601(HomeFragment homeFragment, SearchClickCallback searchClickCallback) {
            super(1);
            this.this$0 = homeFragment;
    ...
    public final void invoke2(SearchClickCallback callback) {
        ...
        if (activity != null) {
            SingleSelectionHelper.INSTANCE.showOptionSelectStringRes(activity, callback.getView(), callback.getCard().getPosterUrl(), CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf((int) R.string.action_open_watching), Integer.valueOf((int) R.string.action_remove_watching)}), CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf((int) R.string.action_open_play), Integer.valueOf((int) R.string.action_open_watching), Integer.valueOf((int) R.string.action_remove_watching)}), new C48601(this.this$0, callback));
        }
    }
}
