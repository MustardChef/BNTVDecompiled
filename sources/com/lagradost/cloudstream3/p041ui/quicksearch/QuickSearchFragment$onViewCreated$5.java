...
import com.lagradost.cloudstream3.p041ui.search.OnGoingSearch;
...
/* renamed from: com.lagradost.cloudstream3.ui.quicksearch.QuickSearchFragment$onViewCreated$5 */
/* loaded from: classes3.dex */
final class QuickSearchFragment$onViewCreated$5 extends Lambda implements Function1<List<? extends OnGoingSearch>, Unit> {
    final /* synthetic */ ReentrantLock $listLock;
    final /* synthetic */ QuickSearchFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QuickSearchFragment$onViewCreated$5(ReentrantLock reentrantLock, QuickSearchFragment quickSearchFragment) {
        super(1);
    ...
    public final void invoke2(List<OnGoingSearch> list) {
        ...
        try {
            try {
                this.$listLock.lock();
                RecyclerView recyclerView = (RecyclerView) this.this$0._$_findCachedViewById(C4761R.C4764id.quick_search_master_recycler);
