...
public final class TvSeriesSearchResponse implements SearchResponse {
    ...
    public final TvSeriesSearchResponse copy(@JsonProperty("name") String name, @JsonProperty("url") String url, @JsonProperty("apiName") String apiName, @JsonProperty("type") TvType tvType, @JsonProperty("posterUrl") String str, @JsonProperty("year") Integer num, @JsonProperty("episodes") Integer num2, @JsonProperty("id") Integer num3, @JsonProperty("quality") SearchQuality searchQuality, @JsonProperty("posterHeaders") Map<String, String> map) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(apiName, "apiName");
        return new TvSeriesSearchResponse(name, url, apiName, tvType, str, num, num2, num3, searchQuality, map);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TvSeriesSearchResponse) {
            TvSeriesSearchResponse tvSeriesSearchResponse = (TvSeriesSearchResponse) obj;
            return Intrinsics.areEqual(getName(), tvSeriesSearchResponse.getName()) && Intrinsics.areEqual(getUrl(), tvSeriesSearchResponse.getUrl()) && Intrinsics.areEqual(getApiName(), tvSeriesSearchResponse.getApiName()) && getType() == tvSeriesSearchResponse.getType() && Intrinsics.areEqual(getPosterUrl(), tvSeriesSearchResponse.getPosterUrl()) && Intrinsics.areEqual(this.year, tvSeriesSearchResponse.year) && Intrinsics.areEqual(this.episodes, tvSeriesSearchResponse.episodes) && Intrinsics.areEqual(getId(), tvSeriesSearchResponse.getId()) && getQuality() == tvSeriesSearchResponse.getQuality() && Intrinsics.areEqual(getPosterHeaders(), tvSeriesSearchResponse.getPosterHeaders());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode2 + (num2 == null ? 0 : num2.hashCode())) * 31) + (getId() == null ? 0 : getId().hashCode())) * 31) + (getQuality() == null ? 0 : getQuality().hashCode())) * 31) + (getPosterHeaders() != null ? getPosterHeaders().hashCode() : 0);
    }

    public String toString() {
        return "TvSeriesSearchResponse(name=" + getName() + ", url=" + getUrl() + ", apiName=" + getApiName() + ", type=" + getType() + ", posterUrl=" + getPosterUrl() + ", year=" + this.year + ", episodes=" + this.episodes + ", id=" + getId() + ", quality=" + getQuality() + ", posterHeaders=" + getPosterHeaders() + ')';
    }

    public TvSeriesSearchResponse(@JsonProperty("name") String name, @JsonProperty("url") String url, @JsonProperty("apiName") String apiName, @JsonProperty("type") TvType tvType, @JsonProperty("posterUrl") String str, @JsonProperty("year") Integer num, @JsonProperty("episodes") Integer num2, @JsonProperty("id") Integer num3, @JsonProperty("quality") SearchQuality searchQuality, @JsonProperty("posterHeaders") Map<String, String> map) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(apiName, "apiName");
        this.name = name;
    ...
    public /* synthetic */ TvSeriesSearchResponse(String str, String str2, String str3, TvType tvType, String str4, Integer num, Integer num2, Integer num3, SearchQuality searchQuality, Map map, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, str3, (i & 8) != 0 ? null : tvType, (i & 16) != 0 ? null : str4, (i & 32) != 0 ? null : num, (i & 64) != 0 ? null : num2, (i & 128) != 0 ? null : num3, (i & 256) != 0 ? null : searchQuality, (i & 512) != 0 ? null : map);
    }
