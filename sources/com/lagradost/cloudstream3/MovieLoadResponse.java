...
public final class MovieLoadResponse implements LoadResponse {
    ...
    public final MovieLoadResponse copy(String name, String url, String apiName, TvType type, String dataUrl, String str, Integer num, String str2, Integer num2, List<String> list, Integer num3, List<String> list2, List<? extends SearchResponse> list3, List<ActorData> list4, boolean z, Map<String, String> syncData, String str3, Map<String, String> map) {
        ...
        return new MovieLoadResponse(name, url, apiName, type, dataUrl, str, num, str2, num2, list, num3, list2, list3, list4, z, syncData, str3, map);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MovieLoadResponse) {
            MovieLoadResponse movieLoadResponse = (MovieLoadResponse) obj;
            return Intrinsics.areEqual(getName(), movieLoadResponse.getName()) && Intrinsics.areEqual(getUrl(), movieLoadResponse.getUrl()) && Intrinsics.areEqual(getApiName(), movieLoadResponse.getApiName()) && getType() == movieLoadResponse.getType() && Intrinsics.areEqual(this.dataUrl, movieLoadResponse.dataUrl) && Intrinsics.areEqual(getPosterUrl(), movieLoadResponse.getPosterUrl()) && Intrinsics.areEqual(getYear(), movieLoadResponse.getYear()) && Intrinsics.areEqual(getPlot(), movieLoadResponse.getPlot()) && Intrinsics.areEqual(getRating(), movieLoadResponse.getRating()) && Intrinsics.areEqual(getTags(), movieLoadResponse.getTags()) && Intrinsics.areEqual(getDuration(), movieLoadResponse.getDuration()) && Intrinsics.areEqual(getTrailers(), movieLoadResponse.getTrailers()) && Intrinsics.areEqual(getRecommendations(), movieLoadResponse.getRecommendations()) && Intrinsics.areEqual(getActors(), movieLoadResponse.getActors()) && getComingSoon() == movieLoadResponse.getComingSoon() && Intrinsics.areEqual(getSyncData(), movieLoadResponse.getSyncData()) && Intrinsics.areEqual(getReviewUrl(), movieLoadResponse.getReviewUrl()) && Intrinsics.areEqual(getPosterHeaders(), movieLoadResponse.getPosterHeaders());
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((((getName().hashCode() * 31) + getUrl().hashCode()) * 31) + getApiName().hashCode()) * 31) + getType().hashCode()) * 31) + this.dataUrl.hashCode()) * 31) + (getPosterUrl() == null ? 0 : getPosterUrl().hashCode())) * 31) + (getYear() == null ? 0 : getYear().hashCode())) * 31) + (getPlot() == null ? 0 : getPlot().hashCode())) * 31) + (getRating() == null ? 0 : getRating().hashCode())) * 31) + (getTags() == null ? 0 : getTags().hashCode())) * 31) + (getDuration() == null ? 0 : getDuration().hashCode())) * 31) + (getTrailers() == null ? 0 : getTrailers().hashCode())) * 31) + (getRecommendations() == null ? 0 : getRecommendations().hashCode())) * 31) + (getActors() == null ? 0 : getActors().hashCode())) * 31;
        boolean comingSoon = getComingSoon();
        int i = comingSoon;
        if (comingSoon) {
            i = 1;
        }
        return ((((((hashCode + i) * 31) + getSyncData().hashCode()) * 31) + (getReviewUrl() == null ? 0 : getReviewUrl().hashCode())) * 31) + (getPosterHeaders() != null ? getPosterHeaders().hashCode() : 0);
    }

    public String toString() {
        return "MovieLoadResponse(name=" + getName() + ", url=" + getUrl() + ", apiName=" + getApiName() + ", type=" + getType() + ", dataUrl=" + this.dataUrl + ", posterUrl=" + getPosterUrl() + ", year=" + getYear() + ", plot=" + getPlot() + ", rating=" + getRating() + ", tags=" + getTags() + ", duration=" + getDuration() + ", trailers=" + getTrailers() + ", recommendations=" + getRecommendations() + ", actors=" + getActors() + ", comingSoon=" + getComingSoon() + ", syncData=" + getSyncData() + ", reviewUrl=" + getReviewUrl() + ", posterHeaders=" + getPosterHeaders() + ')';
    }

    public MovieLoadResponse(String name, String url, String apiName, TvType type, String dataUrl, String str, Integer num, String str2, Integer num2, List<String> list, Integer num3, List<String> list2, List<? extends SearchResponse> list3, List<ActorData> list4, boolean z, Map<String, String> syncData, String str3, Map<String, String> map) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(apiName, "apiName");
        Intrinsics.checkNotNullParameter(type, "type");
    ...
    public /* synthetic */ MovieLoadResponse(String str, String str2, String str3, TvType tvType, String str4, String str5, Integer num, String str6, Integer num2, List list, Integer num3, List list2, List list3, List list4, boolean z, Map map, String str7, Map map2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, str3, tvType, str4, (i & 32) != 0 ? null : str5, (i & 64) != 0 ? null : num, (i & 128) != 0 ? null : str6, (i & 256) != 0 ? null : num2, (i & 512) != 0 ? null : list, (i & 1024) != 0 ? null : num3, (i & 2048) != 0 ? null : list2, (i & 4096) != 0 ? null : list3, (i & 8192) != 0 ? null : list4, (i & 16384) != 0 ? false : z, (32768 & i) != 0 ? new LinkedHashMap() : map, (65536 & i) != 0 ? null : str7, (i & 131072) != 0 ? null : map2);
    }
