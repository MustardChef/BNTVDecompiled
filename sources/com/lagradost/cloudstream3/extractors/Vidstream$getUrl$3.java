...
@DebugMetadata(m99c = "com.lagradost.cloudstream3.extractors.Vidstream$getUrl$3", m98f = "Vidstream.kt", m97i = {0}, m96l = {52}, m95m = "invokeSuspend", m94n = {"link"}, m93s = {"L$0"})
/* loaded from: classes3.dex */
public final class Vidstream$getUrl$3 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
    ...
    public Vidstream$getUrl$3(Vidstream vidstream, String str, String str2, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function12, Continuation<? super Vidstream$getUrl$3> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new Vidstream$getUrl$3(this.this$0, this.$id, this.$extractorUrl, this.$subtitleCallback, this.$callback, continuation);
    }
    ...
    public final Object invoke2(Continuation<Object> continuation) {
        return ((Vidstream$getUrl$3) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (select != null) {
            return ParCollections.apmap(select, new C47751(regex, str, this.$subtitleCallback, this.$callback, this.this$0, niceResponse, null));
        }
        return null;
    }
    ...
    @DebugMetadata(m99c = "com.lagradost.cloudstream3.extractors.Vidstream$getUrl$3$1", m98f = "Vidstream.kt", m97i = {0, 0, 0}, m96l = {65}, m95m = "invokeSuspend", m94n = {"element", ShareConstants.WEB_DIALOG_PARAM_HREF, "qual"}, m93s = {"L$0", "L$1", "L$2"})
    /* renamed from: com.lagradost.cloudstream3.extractors.Vidstream$getUrl$3$1 */
    /* loaded from: classes3.dex */
    public static final class C47751 extends SuspendLambda implements Function2<Element, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function1<ExtractorLink, Unit> $callback;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C47751(Regex regex, String str, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function12, Vidstream vidstream, NiceResponse niceResponse, Continuation<? super C47751> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C47751 c47751 = new C47751(this.$qualityRegex, this.$link, this.$subtitleCallback, this.$callback, this.this$0, this.$page, continuation);
            c47751.L$0 = obj;
            return c47751;
        }
        ...
        public final Object invoke(Element element, Continuation<? super Unit> continuation) {
            return ((C47751) create(element, continuation)).invokeSuspend(Unit.INSTANCE);
        }
