...
public final class DoramasYTProvider$getMainPage$2$1 extends Lambda implements Function1<AnimeSearchResponse, Unit> {
    ...
    public DoramasYTProvider$getMainPage$2$1(DoramasYTProvider doramasYTProvider, String str, String str2, Integer num) {
        super(1);
    ...
    public final void invoke2(AnimeSearchResponse newAnimeSearchResponse) {
        ...
        MainAPIKt.addDubStatus(newAnimeSearchResponse, companion.getDubStatus(title), this.$epNum);
    }
}
