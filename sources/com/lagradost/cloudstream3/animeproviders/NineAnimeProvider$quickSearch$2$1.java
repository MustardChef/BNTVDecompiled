...
final class NineAnimeProvider$quickSearch$2$1 extends Lambda implements Function1<AnimeSearchResponse, Unit> {
    final /* synthetic */ Element $element;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NineAnimeProvider$quickSearch$2$1(Element element) {
        super(1);
    ...
    public final void invoke2(AnimeSearchResponse newAnimeSearchResponse) {
        ...
        Element selectFirst = this.$element.selectFirst(".poster > span > img");
        newAnimeSearchResponse.setPosterUrl(selectFirst != null ? selectFirst.attr("src") : null);
    }
}
