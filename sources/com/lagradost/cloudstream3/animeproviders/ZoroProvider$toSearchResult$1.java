...
final class ZoroProvider$toSearchResult$1 extends Lambda implements Function1<AnimeSearchResponse, Unit> {
    ...
    public ZoroProvider$toSearchResult$1(String str, boolean z, boolean z2, Integer num) {
        super(1);
        this.$posterUrl = str;
        this.$dubExist = z;
        this.$subExist = z2;
