...
public final class AkwamProvider$toEpisode$1 extends Lambda implements Function1<Episode, Unit> {
    ...
    public AkwamProvider$toEpisode$1(String str, AkwamProvider akwamProvider, String str2, String str3) {
        super(1);
        this.$title = str;
    ...
    public final void invoke2(Episode newEpisode) {
        ...
        newEpisode.setName(this.$title);
        AkwamProvider akwamProvider = this.this$0;
        String title = this.$title;
        Intrinsics.checkNotNullExpressionValue(title, "title");
        intFromText = akwamProvider.getIntFromText(title);
        newEpisode.setEpisode(intFromText);
        newEpisode.setPosterUrl(this.$thumbUrl);
