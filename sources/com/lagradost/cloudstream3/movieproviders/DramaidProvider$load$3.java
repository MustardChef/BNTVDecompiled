...
final class DramaidProvider$load$3 extends Lambda implements Function1<TvSeriesLoadResponse, Unit> {
    ...
    public DramaidProvider$load$3(String str, Integer num, ShowStatus showStatus, String str2, List<String> list, List<TvSeriesSearchResponse> list2) {
        super(1);
        this.$poster = str;
        this.$year = num;
    ...
    public final void invoke2(TvSeriesLoadResponse newTvSeriesLoadResponse) {
        ...
        newTvSeriesLoadResponse.setShowStatus(this.$status);
