...
public final class PelisflixProvider$load$3$1 extends Lambda implements Function1<Episode, Unit> {
    ...
    public PelisflixProvider$load$3$1(String str, int i, Integer num, PelisflixProvider pelisflixProvider, String str2, String str3) {
        super(1);
        this.$name = str;
        this.$seasonInt = i;
        this.$epNum = num;
