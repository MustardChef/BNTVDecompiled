...
final class FaselHDProvider$load$6 extends Lambda implements Function1<TvSeriesLoadResponse, Unit> {
    ...
    public FaselHDProvider$load$6(Integer num, String str, Integer num2, String str2, List<String> list, List<? extends SearchResponse> list2) {
        super(1);
        this.$duration = num;
        this.$posterUrl = str;
        this.$year = num2;
