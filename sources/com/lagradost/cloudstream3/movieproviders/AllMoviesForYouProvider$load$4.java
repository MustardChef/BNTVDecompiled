...
final class AllMoviesForYouProvider$load$4 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public AllMoviesForYouProvider$load$4(String str, String str2, String str3, Integer num, String str4) {
        super(1);
    ...
    public final void invoke2(MovieLoadResponse newMovieLoadResponse) {
        ...
        newMovieLoadResponse.setPosterUrl(this.$backgroundPoster);
