...
final class FilmpertuttiProvider$getMainPage$home$1$1 extends Lambda implements Function1<TvSeriesSearchResponse, Unit> {
    final /* synthetic */ String $image;
    final /* synthetic */ SearchQuality $quality;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilmpertuttiProvider$getMainPage$home$1$1(String str, SearchQuality searchQuality) {
        super(1);
        this.$image = str;
    ...
    public final void invoke2(TvSeriesSearchResponse newTvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(this.$image);
        newTvSeriesSearchResponse.setQuality(this.$quality);
    }
}
