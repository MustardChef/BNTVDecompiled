...
final class DramaidProvider$load$2 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public DramaidProvider$load$2(String str, Integer num, String str2, List<String> list, List<TvSeriesSearchResponse> list2) {
        super(1);
        this.$poster = str;
        this.$year = num;
