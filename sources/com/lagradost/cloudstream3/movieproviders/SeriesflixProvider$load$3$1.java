...
public final class SeriesflixProvider$load$3$1 extends Lambda implements Function1<Episode, Unit> {
    ...
    public SeriesflixProvider$load$3$1(String str, Tuples<Integer, String> tuples, Integer num, SeriesflixProvider seriesflixProvider, String str2, String str3) {
        super(1);
        this.$name = str;
        this.$season = tuples;
        this.$epNum = num;
    ...
    public final void invoke2(Episode newEpisode) {
        ...
        newEpisode.setPosterUrl(MainAPIKt.fixUrlNull(this.this$0, this.$epthumb));
