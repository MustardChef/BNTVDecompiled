...
@DebugMetadata(m99c = "com.lagradost.cloudstream3.movieproviders.PelisplusProviderTemplate$loadLinks$3", m98f = "PelisplusProviderTemplate.kt", m97i = {0}, m96l = {bqk.f6541bA, 244}, m95m = "invokeSuspend", m94n = {"serverid"}, m93s = {"L$0"})
/* loaded from: classes3.dex */
public final class PelisplusProviderTemplate$loadLinks$3 extends SuspendLambda implements Function2<Element, Continuation<? super Unit>, Object> {
    ...
    public PelisplusProviderTemplate$loadLinks$3(PelisplusProviderTemplate pelisplusProviderTemplate, String str, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function12, Continuation<? super PelisplusProviderTemplate$loadLinks$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PelisplusProviderTemplate$loadLinks$3 pelisplusProviderTemplate$loadLinks$3 = new PelisplusProviderTemplate$loadLinks$3(this.this$0, this.$data, this.$subtitleCallback, this.$callback, continuation);
    ...
    public final Object invoke(Element element, Continuation<? super Unit> continuation) {
        return ((PelisplusProviderTemplate$loadLinks$3) create(element, continuation)).invokeSuspend(Unit.INSTANCE);
    }
