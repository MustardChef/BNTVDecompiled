...
final class LayarKacaProvider$toTopSearchResult$1 extends Lambda implements Function1<MovieSearchResponse, Unit> {
    final /* synthetic */ String $posterUrl;
    final /* synthetic */ SearchQuality $quality;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$toTopSearchResult$1(String str, SearchQuality searchQuality) {
        super(1);
        this.$posterUrl = str;
