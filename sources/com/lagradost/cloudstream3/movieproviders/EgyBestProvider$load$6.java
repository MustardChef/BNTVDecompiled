...
final class EgyBestProvider$load$6 extends Lambda implements Function1<TvSeriesLoadResponse, Unit> {
    ...
    public EgyBestProvider$load$6(String str, List<String> list, Integer num, String str2, List<ActorData> list2, String str3) {
        super(1);
        this.$posterUrl = str;
        this.$tags = list;
        this.$year = num;
    ...
    public final void invoke2(TvSeriesLoadResponse newTvSeriesLoadResponse) {
        ...
        newTvSeriesLoadResponse.setActors(this.$actors);
