...
final class DramaidProvider$load$recommendations$1$1 extends Lambda implements Function1<TvSeriesSearchResponse, Unit> {
    final /* synthetic */ String $epPoster;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DramaidProvider$load$recommendations$1$1(String str) {
        super(1);
        this.$epPoster = str;
    }
    ...
    public final void invoke2(TvSeriesSearchResponse newTvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(this.$epPoster);
    }
}
