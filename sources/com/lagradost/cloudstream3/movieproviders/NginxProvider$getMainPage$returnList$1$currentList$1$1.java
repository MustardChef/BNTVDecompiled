...
public final class NginxProvider$getMainPage$returnList$1$currentList$1$1 extends Lambda implements Function1<MovieSearchResponse, Unit> {
    final /* synthetic */ Map<String, String> $authHeader;
    final /* synthetic */ String $posterUrl;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NginxProvider$getMainPage$returnList$1$currentList$1$1(String str, Map<String, String> map) {
        super(1);
        this.$posterUrl = str;
        this.$authHeader = map;
    }
    ...
    public final void invoke2(MovieSearchResponse newMovieSearchResponse) {
        ...
        MainAPIKt.addPoster(newMovieSearchResponse, this.$posterUrl, this.$authHeader);
    }
}
