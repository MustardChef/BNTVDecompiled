...
final class EgyBestProvider$load$2 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public EgyBestProvider$load$2(String str, Integer num, List<? extends SearchResponse> list, String str2, List<String> list2, List<ActorData> list3, String str3) {
        super(1);
        this.$posterUrl = str;
        this.$year = num;
