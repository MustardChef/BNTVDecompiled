...
@DebugMetadata(m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2", m98f = "CinecalidadProvider.kt", m97i = {0, 1}, m96l = {161, 163}, m95m = "invokeSuspend", m94n = {"url", "url"}, m93s = {"L$0", "L$0"})
...
public final class CinecalidadProvider$loadLinks$2 extends SuspendLambda implements Function2<Element, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (StringsKt.startsWith$default(url, "https://cinecalidad.lol", false, 2, (Object) null)) {
            ParCollections.apmap(SequencesKt.toList(SequencesKt.map(Regex.findAll$default(new Regex("(https:\\/\\/cinecalidad\\.lol\\/play\\/\\?h=[a-zA-Z0-9]{0,8}[a-zA-Z0-9_-]+)"), url, 0, 2, null), C47761.INSTANCE)), new C47772(this.$data, this.this$0, this.$subtitleCallback, this.$callback, null));
        }
    ...
    /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2$1 */
    /* loaded from: classes3.dex */
    public static final class C47761 extends Lambda implements Function1<MatchResult, String> {
        public static final C47761 INSTANCE = new C47761();
    ...
    @DebugMetadata(m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2$2", m98f = "CinecalidadProvider.kt", m97i = {}, m96l = {171}, m95m = "invokeSuspend", m94n = {}, m93s = {})
    /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2$2 */
    /* loaded from: classes3.dex */
    public static final class C47772 extends SuspendLambda implements Function2<String, Continuation<? super List<? extends Unit>>, Object> {
        final /* synthetic */ Function1<ExtractorLink, Unit> $callback;
        final /* synthetic */ String $data;
        final /* synthetic */ Function1<SubtitleFile, Unit> $subtitleCallback;
        /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C47772(String str, CinecalidadProvider cinecalidadProvider, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function12, Continuation<? super C47772> continuation) {
            super(2, continuation);
            this.$data = str;
            this.this$0 = cinecalidadProvider;
            this.$subtitleCallback = function1;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C47772 c47772 = new C47772(this.$data, this.this$0, this.$subtitleCallback, this.$callback, continuation);
            c47772.L$0 = obj;
            return c47772;
        }
        ...
        public final Object invoke2(String str, Continuation<? super List<Unit>> continuation) {
            return ((C47772) create(str, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ParCollections.apmap(((NiceResponse) obj2).getOkhttpResponse().headers().values(FirebaseAnalytics.Param.LOCATION), new C47781(this.this$0, this.$subtitleCallback, this.$callback, null));
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* compiled from: CinecalidadProvider.kt */
        @Metadata(m108d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, m107d2 = {"<anonymous>", "", "extractedurl", ""}, m106k = 3, m105mv = {1, 6, 0}, m103xi = 48)
        @DebugMetadata(m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2$2$1", m98f = "CinecalidadProvider.kt", m97i = {}, m96l = {190}, m95m = "invokeSuspend", m94n = {}, m93s = {})
        /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$2$2$1 */
        /* loaded from: classes3.dex */
        public static final class C47781 extends SuspendLambda implements Function2<String, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function1<ExtractorLink, Unit> $callback;
            final /* synthetic */ Function1<SubtitleFile, Unit> $subtitleCallback;
            /* synthetic */ Object L$0;
            int label;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C47781(CinecalidadProvider cinecalidadProvider, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function12, Continuation<? super C47781> continuation) {
                super(2, continuation);
                this.this$0 = cinecalidadProvider;
                this.$subtitleCallback = function1;
                this.$callback = function12;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C47781 c47781 = new C47781(this.this$0, this.$subtitleCallback, this.$callback, continuation);
                c47781.L$0 = obj;
                return c47781;
            }
            ...
            public final Object invoke(String str, Continuation<? super Unit> continuation) {
                return ((C47781) create(str, continuation)).invokeSuspend(Unit.INSTANCE);
            }
