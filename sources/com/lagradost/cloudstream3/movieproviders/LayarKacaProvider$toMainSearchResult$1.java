...
final class LayarKacaProvider$toMainSearchResult$1 extends Lambda implements Function1<MovieSearchResponse, Unit> {
    final /* synthetic */ String $posterUrl;
    final /* synthetic */ SearchQuality $quality;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$toMainSearchResult$1(String str, SearchQuality searchQuality) {
        super(1);
        this.$posterUrl = str;
