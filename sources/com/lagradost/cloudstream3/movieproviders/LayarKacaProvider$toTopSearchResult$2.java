...
final class LayarKacaProvider$toTopSearchResult$2 extends Lambda implements Function1<AnimeSearchResponse, Unit> {
    final /* synthetic */ Integer $episode;
    final /* synthetic */ String $posterUrl;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$toTopSearchResult$2(String str, Integer num) {
        super(1);
        this.$posterUrl = str;
        this.$episode = num;
    }
