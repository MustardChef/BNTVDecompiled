...
final class HDrezkaProvider$load$3 extends Lambda implements Function1<TvSeriesLoadResponse, Unit> {
    ...
    public HDrezkaProvider$load$3(String str, Integer num, String str2, List<String> list, Integer num2, List<Actor> list2, List<? extends SearchResponse> list3, String str3) {
        super(1);
        this.$poster = str;
        this.$year = num;
    ...
    public final void invoke2(TvSeriesLoadResponse newTvSeriesLoadResponse) {
        ...
        LoadResponse.Companion.addActorsOnly(tvSeriesLoadResponse, this.$actors);
