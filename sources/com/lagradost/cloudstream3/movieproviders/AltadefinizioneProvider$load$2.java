...
public final class AltadefinizioneProvider$load$2 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public AltadefinizioneProvider$load$2(AltadefinizioneProvider altadefinizioneProvider, String str, int i, String str2, Void r5, List<MovieSearchResponse> list, List<ActorData> list2, List<String> list3, String str3) {
        super(1);
    ...
    public final void invoke2(MovieLoadResponse newMovieLoadResponse) {
        ...
        newMovieLoadResponse.setYear(Integer.valueOf(this.$year));
