...
final class MultiplexProvider$load$2 extends Lambda implements Function1<TvSeriesLoadResponse, Unit> {
    ...
    public MultiplexProvider$load$2(String str, Integer num, String str2, List<String> list, Integer num2, List<String> list2, List<? extends SearchResponse> list3, String str3) {
        super(1);
        this.$poster = str;
        this.$year = num;
