...
final class HDrezkaProvider$load$5 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public HDrezkaProvider$load$5(String str, Integer num, String str2, List<String> list, Integer num2, List<Actor> list2, List<? extends SearchResponse> list3, String str3) {
        super(1);
        this.$poster = str;
        this.$year = num;
    ...
    public final void invoke2(MovieLoadResponse newMovieLoadResponse) {
        ...
        LoadResponse.Companion.addActorsOnly(movieLoadResponse, this.$actors);
