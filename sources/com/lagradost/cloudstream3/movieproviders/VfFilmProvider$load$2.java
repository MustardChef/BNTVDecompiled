...
final class VfFilmProvider$load$2 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public VfFilmProvider$load$2(String str, Integer num, String str2, Integer num2) {
        super(1);
        this.$poster = str;
        this.$year = num;
        this.$descript = str2;
    ...
    public final void invoke2(MovieLoadResponse newMovieLoadResponse) {
        ...
        newMovieLoadResponse.setPlot(this.$descript);
