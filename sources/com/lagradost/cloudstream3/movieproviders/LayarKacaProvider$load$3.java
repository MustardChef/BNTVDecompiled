...
final class LayarKacaProvider$load$3 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public LayarKacaProvider$load$3(String str, Integer num, String str2, List<String> list, Integer num2, List<String> list2, List<TvSeriesSearchResponse> list3, String str3) {
        super(1);
        this.$poster = str;
        this.$year = num;
