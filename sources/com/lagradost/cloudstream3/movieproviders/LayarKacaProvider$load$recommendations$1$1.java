...
final class LayarKacaProvider$load$recommendations$1$1 extends Lambda implements Function1<TvSeriesSearchResponse, Unit> {
    final /* synthetic */ String $recPosterUrl;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$load$recommendations$1$1(String str) {
        super(1);
        this.$recPosterUrl = str;
    }
    ...
    public final void invoke2(TvSeriesSearchResponse newTvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(this.$recPosterUrl);
    }
}
