...
final class LayarKacaProvider$search$2$1 extends Lambda implements Function1<TvSeriesSearchResponse, Unit> {
    final /* synthetic */ String $posterUrl;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$search$2$1(String str) {
        super(1);
        this.$posterUrl = str;
    }
