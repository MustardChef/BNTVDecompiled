...
final class FaselHDProvider$load$2 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public FaselHDProvider$load$2(String str, Integer num, String str2, Integer num2, List<String> list, List<? extends SearchResponse> list2) {
        super(1);
        this.$posterUrl = str;
        this.$year = num;
        this.$synopsis = str2;
