...
final class YomoviesProvider$load$3 extends Lambda implements Function1<MovieLoadResponse, Unit> {
    ...
    public YomoviesProvider$load$3(String str, Integer num, String str2, List<String> list, Integer num2, List<String> list2, List<? extends SearchResponse> list3, String str3) {
        super(1);
        this.$poster = str;
        this.$year = num;
