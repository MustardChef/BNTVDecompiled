...
final class PhimmoichillProvider$toSearchResult$2 extends Lambda implements Function1<MovieSearchResponse, Unit> {
    final /* synthetic */ String $posterUrl;
    final /* synthetic */ String $quality;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PhimmoichillProvider$toSearchResult$2(String str, String str2) {
        super(1);
        this.$posterUrl = str;
        this.$quality = str2;
    }
    ...
    public final void invoke2(MovieSearchResponse newMovieSearchResponse) {
        ...
        MainAPIKt.addQuality(newMovieSearchResponse, this.$quality);
    }
}
