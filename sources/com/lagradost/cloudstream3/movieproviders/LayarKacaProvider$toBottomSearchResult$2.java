...
final class LayarKacaProvider$toBottomSearchResult$2 extends Lambda implements Function1<TvSeriesSearchResponse, Unit> {
    final /* synthetic */ String $posterUrl;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LayarKacaProvider$toBottomSearchResult$2(String str) {
        super(1);
        this.$posterUrl = str;
    }
    ...
    public final void invoke2(TvSeriesSearchResponse newTvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(this.$posterUrl);
    }
}
