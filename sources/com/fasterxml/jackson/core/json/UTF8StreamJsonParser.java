...
import com.fasterxml.jackson.core.p033io.CharTypes;
import com.fasterxml.jackson.core.p033io.IOContext;
...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    protected final String _getText2(JsonToken jsonToken) {
        ...
        int m6071id = jsonToken.m6071id();
        if (m6071id != 5) {
            if (m6071id == 6 || m6071id == 7 || m6071id == 8) {
                return this._textBuffer.contentsAsString();
            }
    ...
    public char[] getTextCharacters() throws IOException {
        if (this._currToken != null) {
            int m6071id = this._currToken.m6071id();
            if (m6071id == 5) {
                if (!this._nameCopied) {
                    String currentName = this._parsingContext.getCurrentName();
                    ...
                    if (iArr[i5] != 0) {
                        ...
                        if (i5 != 34) {
                            ...
                            if (i6 == 1) {
                                ...
                                i5 = (_decodeUtf8_4 & AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES) | 56320;
                            } else if (i5 < 32) {
                        ...
                        if (iArr[i4] == 0 || i4 == 34) {
                            ...
                            if (i5 == 1) {
                                ...
                                if (i5 == 4) {
                                    ...
                                    i4 = 56320 | (_decodeUtf8_4 & AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES);
                                } else {
                                    if (i4 < 32) {
                                        _throwUnquotedSpace(i4, "string value");
                                    }
    ...
    */
    private final void _skipCComment() throws java.io.IOException {
        /*
            r4 = this;
            int[] r0 = com.fasterxml.jackson.core.p033io.CharTypes.getInputCodeComment()
        L4:
            int r1 = r4._inputPtr
            int r2 = r4._inputEnd
            if (r1 < r2) goto L10
