...
public final class CharTypes {
    ...
    /* renamed from: HB */
    protected static final byte[] f2777HB;

    /* renamed from: HC */
    protected static final char[] f2778HC;
    ...
    static {
        ...
        f2777HB = new byte[length];
        for (int i = 0; i < length; i++) {
            f2777HB[i] = (byte) f2778HC[i];
        }
        ...
        for (int i3 = 128; i3 < 256; i3++) {
            iArr2[i3] = (i3 & 224) == 192 ? 2 : (i3 & 240) == 224 ? 3 : (i3 & bqk.f6595cb) == 240 ? 4 : -1;
        }
    ...
    public static char[] copyHexChars() {
        return (char[]) f2778HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f2777HB.clone();
    }
