...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    public final boolean isValueNode() {
        int i = C22761.$SwitchMap$com$fasterxml$jackson$databind$node$JsonNodeType[getNodeType().ordinal()];
    ...
    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo6070at(JsonPointer jsonPointer) {
        ...
        return _at.mo6070at(jsonPointer.tail());
    }

    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo6069at(String str) {
        return mo6070at(JsonPointer.compile(str));
    }
