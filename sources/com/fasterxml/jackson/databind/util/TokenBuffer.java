...
public class TokenBuffer extends JsonGenerator {
    ...
    public void serialize(JsonGenerator jsonGenerator) throws IOException {
        ...
        while (true) {
            ...
            switch (C23231.$SwitchMap$com$fasterxml$jackson$core$JsonToken[type.ordinal()]) {
                case 1:
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (C23231.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonParser.currentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
            ...
            case 8:
                ...
                int i2 = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i2 == 3) {
                    writeNumber(jsonParser.getDecimalValue());
                    return;
                } else if (i2 == 4) {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C23231 {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            if (this._mayHaveNativeIds) {
                _checkNativeIds(jsonParser);
            }
    ...
    protected void _copyBufferContents(JsonParser jsonParser) throws IOException {
        ...
        while (true) {
            ...
            int i2 = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonToken[nextToken.ordinal()];
            if (i2 == 1) {
                if (this._mayHaveNativeIds) {
                    _checkNativeIds(jsonParser);
                }
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            ...
            return jsonLocation == null ? JsonLocation.f2776NA : jsonLocation;
        }
        ...
        public String getText() {
            if (this._currToken == JsonToken.VALUE_STRING || this._currToken == JsonToken.FIELD_NAME) {
                ...
                int i = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()];
                if (i == 7 || i == 8) {
                    return ClassUtil.nullOrToString(_currentObject());
                }
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            int i = C23231.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[getNumberType().ordinal()];
            if (i != 1) {
                if (i == 2) {
