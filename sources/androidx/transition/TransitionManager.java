...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition m8529clone = transition.m8529clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            m8529clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, m8529clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, m8529clone);
    }
    ...
    /* renamed from: go */
    public static void m8442go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m8441go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition m8529clone = transition.m8529clone();
        sceneChangeSetup(viewGroup, m8529clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m8529clone);
    }
