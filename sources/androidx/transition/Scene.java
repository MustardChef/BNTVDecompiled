...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup viewGroup, int i, Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C0814R.C0817id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            viewGroup.setTag(C0814R.C0817id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    public static void setCurrentScene(ViewGroup viewGroup, Scene scene) {
        viewGroup.setTag(C0814R.C0817id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup viewGroup) {
        return (Scene) viewGroup.getTag(C0814R.C0817id.transition_current_scene);
    }
