...
public final class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f145id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof IdAndState) {
                ...
                return this.f146id.equals(idAndState.f146id);
            }
            return false;
        }

        public int hashCode() {
            return (this.f146id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f147id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof WorkInfoPojo) {
                ...
                if (str == null ? workInfoPojo.f147id == null : str.equals(workInfoPojo.f147id)) {
