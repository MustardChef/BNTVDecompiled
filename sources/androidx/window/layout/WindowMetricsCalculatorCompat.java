...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public final Rect computeWindowBoundsP$window_release(Activity activity) {
        ...
        if ((rect.width() < point.x || rect.height() < point.y) && !ActivityCompatHelper.INSTANCE.isInMultiWindowMode(activity) && (cutoutForDisplay = getCutoutForDisplay(currentDisplay)) != null) {
