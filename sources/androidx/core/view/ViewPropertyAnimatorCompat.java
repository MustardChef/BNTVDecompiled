...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m8452x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m8451y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m8450z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            Api21Impl.m8449z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* renamed from: z */
        static ViewPropertyAnimator m8449z(ViewPropertyAnimator viewPropertyAnimator, float f) {
