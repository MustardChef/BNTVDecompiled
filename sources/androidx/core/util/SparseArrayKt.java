...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrElse(SparseArray<T> sparseArray, int i, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
