...
public final class SparseArray {
    ...
    public static final <T> T getOrElse(SparseArrayCompat<T> receiver$0, int i, Functions<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
