...
public final class LongSparseArrayKt {
    ...
    public static final <T> T getOrElse(LongSparseArray<T> receiver$0, long j, Functions<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
