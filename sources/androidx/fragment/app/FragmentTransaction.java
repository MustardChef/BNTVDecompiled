...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0443Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0443Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0443Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0443Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0443Op(C0443Op c0443Op) {
            this.mCmd = c0443Op.mCmd;
            this.mFragment = c0443Op.mFragment;
            this.mFromExpandedOp = c0443Op.mFromExpandedOp;
            this.mEnterAnim = c0443Op.mEnterAnim;
            this.mExitAnim = c0443Op.mExitAnim;
            this.mPopEnterAnim = c0443Op.mPopEnterAnim;
            this.mPopExitAnim = c0443Op.mPopExitAnim;
            this.mOldMaxState = c0443Op.mOldMaxState;
            this.mCurrentMaxState = c0443Op.mCurrentMaxState;
        }
    }
    ...
    public FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0443Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0443Op(it.next()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addOp(C0443Op c0443Op) {
        this.mOps.add(c0443Op);
        c0443Op.mEnterAnim = this.mEnterAnim;
        c0443Op.mExitAnim = this.mExitAnim;
        c0443Op.mPopEnterAnim = this.mPopEnterAnim;
        c0443Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0443Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0443Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0443Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0443Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0443Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0443Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0443Op(10, fragment, state));
        return this;
    }
