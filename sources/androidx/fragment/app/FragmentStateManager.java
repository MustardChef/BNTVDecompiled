...
public class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i2 = C04412.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C04412 {
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0394R.C0395id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
