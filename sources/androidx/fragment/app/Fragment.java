...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performConfigurationChanged(Configuration configuration) {
        ...
        this.mChildFragmentManager.lambda$new$0$FragmentManager(configuration);
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle lambda$attachController$4$FragmentManager = this.mChildFragmentManager.lambda$attachController$4$FragmentManager();
        if (lambda$attachController$4$FragmentManager != null) {
            bundle.putParcelable("android:support:fragments", lambda$attachController$4$FragmentManager);
        }
    }
