...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$t3WwJ1XbNlapyNW0l552nMkkXdo
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return FragmentActivity.this.lambda$init$0$FragmentActivity();
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$UpIcD_fWrvv5DXXVvwm-RJ3bKrA
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                FragmentActivity.this.lambda$init$1$FragmentActivity((Configuration) obj);
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$SP1hanWdTqO_BoGCQWOxhjR39jQ
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                FragmentActivity.this.lambda$init$2$FragmentActivity((Intent) obj);
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$euPNEtWNfVdMY89Jt5kWt_WEHqw
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                FragmentActivity.this.lambda$init$3$FragmentActivity(context);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$init$1$FragmentActivity(Configuration configuration) {
        this.mFragments.noteStateNotSaved();
    }

    public /* synthetic */ void lambda$init$2$FragmentActivity(Intent intent) {
        this.mFragments.noteStateNotSaved();
    }

    public /* synthetic */ void lambda$init$3$FragmentActivity(Context context) {
