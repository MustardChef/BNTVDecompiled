...
import androidx.fragment.C0394R;
...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentManager$fsqPmeLyp8R2NG2vLmIMKnwX3q4
        ...
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$0$FragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentManager$OSbytOFWiBhg-JuC-68xxqeOPrI
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$1$FragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentManager$VJusB-xtSf6gkO7njmGWkIPixRc
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$2$FragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.-$$Lambda$FragmentManager$RBeuZ6iM1FSdhmZNBJJQnbWnePM
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$3$FragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0394R.C0395id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z && this.mCurState >= 1) {
            for (int i4 = i; i4 < i2; i4++) {
                Iterator<FragmentTransaction.C0443Op> it = arrayList.get(i4).mOps.iterator();
                while (it.hasNext()) {
        ...
        for (int i5 = i; i5 < i2; i5++) {
            ...
            if (booleanValue) {
                ...
                Iterator<FragmentTransaction.C0443Op> it2 = backStackRecord2.mOps.iterator();
                while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0443Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C0394R.C0395id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0394R.C0395id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0394R.C0395id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mBeingSaved) {
                Iterator<FragmentTransaction.C0443Op> it2 = next.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C0443Op next2 = it2.next();
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = findBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            Iterator<FragmentTransaction.C0443Op> it = backStackRecord2.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0443Op next = it.next();
    ...
    public Parcelable saveAllState() {
        ...
        Bundle lambda$attachController$4$FragmentManager = lambda$attachController$4$FragmentManager();
        if (lambda$attachController$4$FragmentManager.isEmpty()) {
            return null;
        }
        return lambda$attachController$4$FragmentManager;
    }
    ...
    public void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if ((fragmentHostCallback2 instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.-$$Lambda$FragmentManager$sido8p6zuWx0PQxIkv4qM-BRiGM
                @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
                public final Bundle saveState() {
                    return FragmentManager.this.lambda$attachController$4$FragmentManager();
                }
            });
    ...
    public void lambda$new$0$FragmentManager(Configuration configuration) {
        for (Fragment fragment : this.mFragmentStore.getFragments()) {
            if (fragment != null) {
