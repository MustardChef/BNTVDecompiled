...
class ConcurrencyHelpers {
    ...
    public static ThreadPoolExecutor createBackgroundPriorityExecutor(final String str) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, 15L, TimeUnit.SECONDS, new LinkedBlockingDeque(), new ThreadFactory() { // from class: androidx.emoji2.text.-$$Lambda$ConcurrencyHelpers$rm7NN8F9tEuy2Vr8i0fl8_hnx_A
    ...
    public static Executor convertHandlerToExecutor(final Handler handler) {
        ...
        return new Executor() { // from class: androidx.emoji2.text.-$$Lambda$xMC8M6LLEeW997bBmO6BCC6GGAM
