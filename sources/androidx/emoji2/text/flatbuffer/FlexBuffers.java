...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            ...
            if (i == 2) {
                readUInt = FlexBuffers.readUInt(this.f114bb, this.end, this.parentWidth);
            } else if (i == 3) {
        ...
        public boolean asBoolean() {
            return isBoolean() ? this.f114bb.get(this.end) != 0 : asUInt() != 0;
        }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            ...
            return this.f113bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f113bb, FlexBuffers.indirect(this.f113bb, i, this.byteWidth), FlexBuffers.readInt(this.f113bb, i + this.byteWidth, this.byteWidth), 4));
        }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f113bb, FlexBuffers.indirect(this.vec.f113bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
