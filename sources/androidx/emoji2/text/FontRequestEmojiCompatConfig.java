    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                ...
                this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.-$$Lambda$1krYUR4lNugraynDYEm9HSHrNdg
        ...
        private void scheduleRetry(Uri uri, long j) {
            synchronized (this.mLock) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.-$$Lambda$aVrkOgYvqGr2lZJFFK92kv_FgWg
                        @Override // java.lang.Runnable
                        public final void run() {
