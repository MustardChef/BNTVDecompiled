...
public final class WithLifecycleStateKt {
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(final Lifecycle lifecycle, final Lifecycle.State state, boolean z, CoroutineDispatcher coroutineDispatcher, final Functions<? extends R> functions, Continuation<? super R> continuation) {
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m9066constructorimpl = Result.m9066constructorimpl(functions2.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.Companion;
                        m9066constructorimpl = Result.m9066constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(m9066constructorimpl);
                } else if (event == Lifecycle.Event.ON_DESTROY) {
                    lifecycle.removeObserver(this);
                    Result.Companion companion3 = Result.Companion;
                    cancellableContinuationImpl2.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(new WithLifecycleState())));
                }
            }
        };
        if (z) {
