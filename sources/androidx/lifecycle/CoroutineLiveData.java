...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public CoroutineLiveData(CoroutineContext context, long j, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        ...
        this.blockRunner = new BlockRunner<>(this, block, j, CoroutineScopeKt.CoroutineScope(Dispatchers.getMain().getImmediate().plus(context).plus(SupervisorKt.SupervisorJob((Job) context.get(Job.Key)))), new C04761(this));
    }

    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m108d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\n"}, m107d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE}, m106k = 3, m105mv = {1, 5, 1}, m103xi = 48)
    /* renamed from: androidx.lifecycle.CoroutineLiveData$1 */
    /* loaded from: classes.dex */
    static final class C04761 extends Lambda implements Functions<Unit> {
        final /* synthetic */ CoroutineLiveData<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04761(CoroutineLiveData<T> coroutineLiveData) {
            super(0);
