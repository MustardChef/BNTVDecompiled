    ...
    public static final <T> Constructor<T> findMatchingConstructor(Class<T> modelClass, List<? extends Class<?>> signature) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            if (Intrinsics.areEqual(signature, list)) {
                Objects.requireNonNull(constructor2, "null cannot be cast to non-null type java.lang.reflect.Constructor<T of androidx.lifecycle.SavedStateViewModelFactoryKt.findMatchingConstructor>");
                return constructor2;
