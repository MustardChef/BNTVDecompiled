...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0554R.attr.mediaRouteButtonStyle);
    }
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C0554R.styleable.MediaRouteButton, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context2, C0554R.styleable.MediaRouteButton, attributeSet, obtainStyledAttributes, i, 0);
        if (isInEditMode()) {
            this.mRouter = null;
            this.mCallback = null;
            this.mRemoteIndicator = getResources().getDrawable(obtainStyledAttributes.getResourceId(C0554R.styleable.MediaRouteButton_externalRouteEnabledDrawableStatic, 0));
            return;
        }
        ...
        this.mButtonTint = obtainStyledAttributes.getColorStateList(C0554R.styleable.MediaRouteButton_mediaRouteButtonTint);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0554R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = obtainStyledAttributes.getDimensionPixelSize(C0554R.styleable.MediaRouteButton_android_minHeight, 0);
        int resourceId = obtainStyledAttributes.getResourceId(C0554R.styleable.MediaRouteButton_externalRouteEnabledDrawableStatic, 0);
        this.mRemoteIndicatorResIdToLoad = obtainStyledAttributes.getResourceId(C0554R.styleable.MediaRouteButton_externalRouteEnabledDrawable, 0);
    ...
    private void updateContentDescription() {
        ...
        int i2 = this.mConnectionState;
        if (i2 == 1) {
            i = C0554R.string.mr_cast_button_connecting;
        } else if (i2 == 2) {
            i = C0554R.string.mr_cast_button_connected;
        } else {
            i = C0554R.string.mr_cast_button_disconnected;
        }
