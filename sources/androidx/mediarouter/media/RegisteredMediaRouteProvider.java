        ...
        if (descriptor != null) {
            ...
            for (int i = 0; i < size; i++) {
                if (routes.get(i).getId().equals(str)) {
                    ...
                    RegisteredRouteController registeredRouteController2 = registeredRouteController;
                    this.mControllerConnections.add(registeredRouteController2);
                    if (this.mConnectionReady) {
                        registeredRouteController2.attachConnection(this.mActiveConnection);
                    }
                    updateBinding();
        ...
        if (descriptor != null) {
            ...
            for (int i = 0; i < size; i++) {
                if (routes.get(i).getId().equals(str)) {
                    ...
                    RegisteredDynamicController registeredDynamicController2 = registeredDynamicController;
                    this.mControllerConnections.add(registeredDynamicController2);
                    if (this.mConnectionReady) {
                        registeredDynamicController2.attachConnection(this.mActiveConnection);
                    }
                    updateBinding();
