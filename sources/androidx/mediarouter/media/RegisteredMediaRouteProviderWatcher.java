...
public final class RegisteredMediaRouteProviderWatcher {
    ...
    List<ServiceInfo> getMediaRoute2ProviderServices() {
        return (List) this.mPackageManager.queryIntentServices(new Intent(MediaRoute2ProviderServiceAdapter.SERVICE_INTERFACE), 0).stream().map(C0595xc29a1a33.INSTANCE).collect(Collectors.toList());
    }
