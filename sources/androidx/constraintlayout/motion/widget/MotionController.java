...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f83x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f84y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f83x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f84y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f83x;
        rectF.top = this.mStartMotionPath.f84y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f83x;
        rectF2.top = this.mEndMotionPath.f84y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f83x - this.mStartMotionPath.f83x;
        float f2 = this.mEndMotionPath.f84y - this.mStartMotionPath.f84y;
        float f3 = this.mStartMotionPath.f83x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f84y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                ...
                dArr6[i16][0] = motionPathsArr[i16].f83x;
                dArr6[i16][1] = motionPathsArr[i16].f84y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f83x + " y: " + this.mStartMotionPath.f84y + " end: x: " + this.mEndMotionPath.f83x + " y: " + this.mEndMotionPath.f84y;
    }
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            c = 1;
            float f5 = this.mStartMotionPath.f83x + ((this.mEndMotionPath.f83x - this.mStartMotionPath.f83x) * f4);
            float f6 = f5 + 0.5f;
            int i3 = (int) f6;
            float f7 = this.mStartMotionPath.f84y + ((this.mEndMotionPath.f84y - this.mStartMotionPath.f84y) * f4) + 0.5f;
            int i4 = (int) f7;
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f83x - this.mStartMotionPath.f83x;
        float f3 = this.mEndMotionPath.f84y - this.mStartMotionPath.f84y;
