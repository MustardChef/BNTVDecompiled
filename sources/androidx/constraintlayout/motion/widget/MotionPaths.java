...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f8 = startTimePoint.f83x;
        float f9 = startTimePoint.f84y;
        float f10 = (endTimePoint.f83x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (endTimePoint.f84y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f83x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f84y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 0;
        this.f83x = (int) (((startTimePoint.f83x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f84y = (int) (((startTimePoint.f84y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPolar(int parentWidth, int parentHeight, KeyPosition c, MotionPaths s, MotionPaths e) {
        ...
        if (i == 1) {
            ...
            float f10 = e.f83x;
            float f11 = s.f83x;
            this.f83x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(c.mPercentY)) {
                f2 = c.mPercentY;
            }
            float f12 = e.f84y;
            float f13 = s.f84y;
            this.f84y = (f2 * (f12 - f13)) + f13;
        } else if (i == 2) {
            ...
            float f19 = e.f83x;
            float f20 = s.f83x;
            this.f83x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(c.mPercentY)) {
                f2 = c.mPercentY;
            }
            float f21 = e.f84y;
            float f22 = s.f84y;
            this.f84y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(MotionController mc, MotionPaths relative) {
        double d = ((this.f83x + (this.width / 2.0f)) - relative.f83x) - (relative.width / 2.0f);
        double d2 = ((this.f84y + (this.height / 2.0f)) - relative.f84y) - (relative.height / 2.0f);
        this.mRelativeToController = mc;
        this.f83x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f84y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f84y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f8 = startTimePoint.f83x;
        float f9 = startTimePoint.f84y;
        float f10 = endTimePoint.f83x + (f4 / 2.0f);
        float f11 = endTimePoint.f84y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f83x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f84y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(c.mPercentX)) {
            this.f83x = (int) (c.mPercentX * ((int) (parentWidth - this.width)));
        }
        if (!Float.isNaN(c.mPercentY)) {
            this.f84y = (int) (c.mPercentY * ((int) (parentHeight - this.height)));
        }
    ...
    void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f10 = startTimePoint.f84y;
        float f11 = startTimePoint.height;
        float f12 = (endTimePoint.f83x + (endTimePoint.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (endTimePoint.f84y + (endTimePoint.height / 2.0f)) - ((f11 / 2.0f) + f10);
        float f14 = f12 * f3;
        float f15 = (f6 * f4) / 2.0f;
        this.f83x = (int) ((f8 + f14) - f15);
        float f16 = f3 * f13;
        float f17 = (f7 * f5) / 2.0f;
        this.f84y = (int) ((f10 + f16) - f17);
        this.width = (int) (f9 + f);
        this.height = (int) (f11 + f2);
        float f18 = Float.isNaN(c.mPercentY) ? 0.0f : c.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((startTimePoint.f83x + f14) - f15);
        this.f83x = f19;
        float f20 = (int) ((startTimePoint.f84y + f16) - f17);
        this.f84y = f20;
        this.f83x = f19 + ((-f13) * f18);
        this.f84y = f20 + (f12 * f18);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(c.mTransitionEasing);
        this.mPathMotionArc = c.mPathMotionArc;
    }
    ...
    public void different(MotionPaths points, boolean[] mask, String[] custom, boolean arcMode) {
        boolean diff = diff(this.f83x, points.f83x);
        boolean diff2 = diff(this.f84y, points.f84y);
    ...
    public void setView(float position, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        ...
        int i8 = i6 - i4;
        int i9 = i7 - i5;
        if (((i8 == view.getMeasuredWidth() && i9 == view.getMeasuredHeight()) ? true : true) || mForceMeasure) {
    ...
    public void fillStandard(double[] data, int[] toUse) {
        float[] fArr = {this.position, this.f83x, this.f84y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 = 0; i2 < toUse.length; i2++) {
            if (toUse[i2] < 6) {
