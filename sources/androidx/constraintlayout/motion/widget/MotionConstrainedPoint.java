...
public class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    void different(MotionConstrainedPoint points, boolean[] mask, String[] custom) {
        ...
        mask[1] = mask[1] | diff(this.f79x, points.f79x);
        mask[2] = mask[2] | diff(this.f80y, points.f80y);
    ...
    void fillStandard(double[] data, int[] toUse) {
        float[] fArr = {this.position, this.f79x, this.f80y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
