...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, C0257R.styleable.ConstraintLayout_Layout);
    ...
    private int findId(String referenceId) {
        ...
        if (i == 0) {
            try {
                i = C0257R.C0260id.class.getField(referenceId).getInt(null);
