...
public class Placeholder extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        this.mContentId = -1;
        if (attrs != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, C0257R.styleable.ConstraintLayout_placeholder);
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(bqk.f6587bu, bqk.f6587bu, bqk.f6587bu);
            Paint paint = new Paint();
            paint.setARGB(255, bqk.f6549bI, bqk.f6549bI, bqk.f6549bI);
