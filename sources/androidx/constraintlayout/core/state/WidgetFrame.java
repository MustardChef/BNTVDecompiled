    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i5 = (int) (findPreviousPosition.f64x * i);
                i7 = i2;
                i12 = (int) (findPreviousPosition.f65y * i7);
            ...
            if (findNextPosition != null) {
                i13 = (int) (findNextPosition.f64x * i6);
                i14 = (int) (findNextPosition.f65y * i7);
        ...
        int i20 = (int) (i19 + ((i13 - i19) * f5));
        widgetFrame.left = i20;
        int i21 = (int) (i12 + (f5 * (i14 - i12)));
        widgetFrame.top = i21;
        float f10 = 1.0f - f;
        widgetFrame.right = i20 + ((int) ((i3 * f10) + (i17 * f)));
        widgetFrame.bottom = i21 + ((int) ((f10 * i4) + (i18 * f)));
