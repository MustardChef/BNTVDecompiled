...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f47x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f48y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f47x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f48y;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f47x;
        floatRect.top = this.mStartMotionPath.f48y;
        ...
        floatRect2.left = this.mEndMotionPath.f47x;
        floatRect2.top = this.mEndMotionPath.f48y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f47x - this.mStartMotionPath.f47x;
        float f4 = this.mEndMotionPath.f48y - this.mStartMotionPath.f48y;
        float f5 = this.mStartMotionPath.f47x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f48y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i19 = 0; i19 < size; i19++) {
                ...
                dArr6[i19][0] = motionPathsArr[i19].f47x;
                dArr6[i19][1] = motionPathsArr[i19].f48y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f47x + " y: " + this.mStartMotionPath.f48y + " end: x: " + this.mEndMotionPath.f47x + " y: " + this.mEndMotionPath.f48y;
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) Easing.this.getDiff(this.f44mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.f47x + ((this.mEndMotionPath.f47x - this.mStartMotionPath.f47x) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.f48y + ((this.mEndMotionPath.f48y - this.mStartMotionPath.f48y) * f5) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f47x - this.mStartMotionPath.f47x;
        float f6 = this.mEndMotionPath.f48y - this.mStartMotionPath.f48y;
