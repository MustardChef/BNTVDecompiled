...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f47x;
        float f9 = motionPaths.f48y;
        float f10 = (motionPaths2.f47x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f48y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f47x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f48y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 0;
        this.f47x = (int) (((motionPaths.f47x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f48y = (int) (((motionPaths.f48y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f47x;
            float f11 = motionPaths.f47x;
            this.f47x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f48y;
            float f13 = motionPaths.f48y;
            this.f48y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f47x;
                float f15 = motionPaths.f47x;
                min = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f47x = min;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f48y;
                float f17 = motionPaths.f48y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = motionKeyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f47x;
            float f20 = motionPaths.f47x;
            this.f47x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f48y;
            float f22 = motionPaths.f48y;
            this.f48y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f47x + (this.width / 2.0f)) - motionPaths.f47x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f48y + (this.height / 2.0f)) - motionPaths.f48y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f47x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f48y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f48y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f47x;
        float f9 = motionPaths.f48y;
        float f10 = motionPaths2.f47x + (f4 / 2.0f);
        float f11 = motionPaths2.f48y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f47x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f48y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f47x = (int) (motionKeyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f48y = (int) (motionKeyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = motionPaths.f48y;
        float f11 = motionPaths.height;
        float f12 = (motionPaths2.f47x + (motionPaths2.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (motionPaths2.f48y + (motionPaths2.height / 2.0f)) - ((f11 / 2.0f) + f10);
        float f14 = f12 * f3;
        float f15 = (f6 * f4) / 2.0f;
        this.f47x = (int) ((f8 + f14) - f15);
        float f16 = f3 * f13;
        float f17 = (f7 * f5) / 2.0f;
        this.f48y = (int) ((f10 + f16) - f17);
        this.width = (int) (f9 + f);
        this.height = (int) (f11 + f2);
        float f18 = Float.isNaN(motionKeyPosition.mPercentY) ? 0.0f : motionKeyPosition.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f47x + f14) - f15);
        this.f47x = f19;
        float f20 = (int) ((motionPaths.f48y + f16) - f17);
        this.f48y = f20;
        this.f47x = f19 + ((-f13) * f18);
        this.f48y = f20 + (f12 * f18);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean diff = diff(this.f47x, motionPaths.f47x);
        boolean diff2 = diff(this.f48y, motionPaths.f48y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f47x, this.f48y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 = 0; i2 < iArr.length; i2++) {
            if (iArr[i2] < 6) {
                dArr[i] = fArr[iArr[i2]];
