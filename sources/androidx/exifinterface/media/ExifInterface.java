...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f9757CR, 10, Ascii.SUB, 10};
    ...
    static {
        ...
        ExifTag[] exifTagArr6 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, bqk.f6530aq, 2), new ExifTag(TAG_MAKE, bqk.f6531ar, 2), new ExifTag(TAG_MODEL, bqk.f6532as, 2), new ExifTag(TAG_STRIP_OFFSETS, bqk.f6533at, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, bqk.f6534au, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, bqk.f6578bl, 3), new ExifTag(TAG_ROWS_PER_STRIP, bqk.f6536aw, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, bqk.f6537ax, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_REMOVED, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr6;
        TAG_RAF_IMAGE_SIZE = new ExifTag(TAG_STRIP_OFFSETS, bqk.f6533at, 3);
        ...
        JPEG_INTERCHANGE_FORMAT_LENGTH_TAG = new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_REMOVED, 4);
        ...
        Charset forName = Charset.forName(C3282C.ASCII_NAME);
        ASCII = forName;
    ...
    public static class ExifAttribute {
        ...
        /* JADX WARN: Not initialized variable reg: 3, insn: 0x01a4: MOVE  (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:152:0x01a4 */
        /* JADX WARN: Removed duplicated region for block: B:169:0x01a7 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00ba A[Catch: all -> 0x0112, Exception -> 0x0115, TryCatch #12 {Exception -> 0x0115, all -> 0x0112, blocks: (B:43:0x00b1, B:45:0x00ba, B:52:0x00d8, B:46:0x00c2, B:48:0x00c6, B:50:0x00ca), top: B:107:0x00b1 }] */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00c2 A[Catch: all -> 0x0112, Exception -> 0x0115, TryCatch #12 {Exception -> 0x0115, all -> 0x0112, blocks: (B:43:0x00b1, B:45:0x00ba, B:52:0x00d8, B:46:0x00c2, B:48:0x00c6, B:50:0x00ca), top: B:107:0x00b1 }] */
    /* JADX WARN: Removed duplicated region for block: B:56:0x00e7 A[Catch: all -> 0x0106, Exception -> 0x0108, TryCatch #13 {Exception -> 0x0108, all -> 0x0106, blocks: (B:54:0x00e2, B:56:0x00e7, B:59:0x00ef, B:62:0x00f7), top: B:106:0x00e2 }] */
