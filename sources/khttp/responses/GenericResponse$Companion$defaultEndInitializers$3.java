...
final class GenericResponse$Companion$defaultEndInitializers$3 extends Lambda implements Function2<GenericResponse, HttpURLConnection, Unit> {
    public static final GenericResponse$Companion$defaultEndInitializers$3 INSTANCE = new GenericResponse$Companion$defaultEndInitializers$3();

    GenericResponse$Companion$defaultEndInitializers$3() {
        super(2);
    }
    ...
    public final void invoke2(GenericResponse response, HttpURLConnection connection) {
        ...
        cookieJar.putAll(GenericResponse.Companion.getCookieJar$library_release(connection));
    }
}
