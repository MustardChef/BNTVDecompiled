...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m10253getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m9065boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m10253getResultxLWZpok = m10253getResultxLWZpok();
                if (m10253getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m10253getResultxLWZpok.m9075unboximpl());
                }
            }
        }
    }
