...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Functions<? extends R> block) {
        ...
        try {
            ...
            return Result.m9066constructorimpl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m9066constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            return Result.m9066constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m9066constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return m9069exceptionOrNullimpl == null ? obj : onFailure.invoke(m9069exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m9072isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable m9069exceptionOrNullimpl = Result.m9069exceptionOrNullimpl(obj);
        if (m9069exceptionOrNullimpl == null) {
            return onSuccess.invoke(obj);
        }
        return onFailure.invoke(m9069exceptionOrNullimpl);
    }

    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (Result.m9073isSuccessimpl(obj)) {
            Result.Companion companion = Result.Companion;
            return Result.m9066constructorimpl(transform.invoke(obj));
        }
        return Result.m9066constructorimpl(obj);
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m9066constructorimpl(transform.invoke(m9069exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable m9069exceptionOrNullimpl = Result.m9069exceptionOrNullimpl(obj);
        if (m9069exceptionOrNullimpl != null) {
            action.invoke(m9069exceptionOrNullimpl);
        }
        return obj;
    }
