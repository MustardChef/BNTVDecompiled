...
public class Utils extends FilesKt__FileTreeWalkKt {
    ...
    */
    public static final boolean copyRecursively(java.io.File r11, java.io.File r12, boolean r13, kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.p043io.OnErrorAction> r14) {
        /*
            ...
            kotlin.io.OnErrorAction r12 = kotlin.p043io.OnErrorAction.TERMINATE
            if (r11 == r12) goto L2c
            goto L2d
        L2c:
            r1 = 0
        L2d:
            return r1
        L2e:
            kotlin.io.FileTreeWalk r0 = kotlin.p043io.FilesKt.walkTopDown(r11)     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.io.FilesKt__UtilsKt$copyRecursively$2 r3 = new kotlin.io.FilesKt__UtilsKt$copyRecursively$2     // Catch: kotlin.p043io.TerminateException -> Lde
            r3.<init>(r14)     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.jvm.functions.Function2 r3 = (kotlin.jvm.functions.Function2) r3     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.io.FileTreeWalk r0 = r0.onFail(r3)     // Catch: kotlin.p043io.TerminateException -> Lde
            java.util.Iterator r0 = r0.iterator()     // Catch: kotlin.p043io.TerminateException -> Lde
        L41:
            boolean r3 = r0.hasNext()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r3 == 0) goto Ldd
            java.lang.Object r3 = r0.next()     // Catch: kotlin.p043io.TerminateException -> Lde
            java.io.File r3 = (java.io.File) r3     // Catch: kotlin.p043io.TerminateException -> Lde
            boolean r4 = r3.exists()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 != 0) goto L68
            kotlin.io.NoSuchFileException r10 = new kotlin.io.NoSuchFileException     // Catch: kotlin.p043io.TerminateException -> Lde
            r6 = 0
            ...
            r4 = r10
            r5 = r3
            r4.<init>(r5, r6, r7, r8, r9)     // Catch: kotlin.p043io.TerminateException -> Lde
            java.lang.Object r3 = r14.invoke(r3, r10)     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.io.OnErrorAction r4 = kotlin.p043io.OnErrorAction.TERMINATE     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r3 != r4) goto L41
            return r2
        L68:
            java.lang.String r4 = kotlin.p043io.FilesKt.toRelativeString(r3, r11)     // Catch: kotlin.p043io.TerminateException -> Lde
            java.io.File r5 = new java.io.File     // Catch: kotlin.p043io.TerminateException -> Lde
            r5.<init>(r12, r4)     // Catch: kotlin.p043io.TerminateException -> Lde
            boolean r4 = r5.exists()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 == 0) goto Lae
            boolean r4 = r3.isDirectory()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 == 0) goto L83
            boolean r4 = r5.isDirectory()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 != 0) goto Lae
        L83:
            if (r13 != 0) goto L87
        L85:
        ...
        L87:
            boolean r4 = r5.isDirectory()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 == 0) goto L94
            boolean r4 = kotlin.p043io.FilesKt.deleteRecursively(r5)     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 != 0) goto L9b
            goto L85
        L94:
            boolean r4 = r5.delete()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 != 0) goto L9b
            goto L85
        L9b:
            r4 = 0
        L9c:
            if (r4 == 0) goto Lae
            kotlin.io.FileAlreadyExistsException r4 = new kotlin.io.FileAlreadyExistsException     // Catch: kotlin.p043io.TerminateException -> Lde
            java.lang.String r6 = "The destination file already exists."
            r4.<init>(r3, r5, r6)     // Catch: kotlin.p043io.TerminateException -> Lde
            java.lang.Object r3 = r14.invoke(r5, r4)     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.io.OnErrorAction r4 = kotlin.p043io.OnErrorAction.TERMINATE     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r3 != r4) goto L41
            return r2
        Lae:
            boolean r4 = r3.isDirectory()     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r4 == 0) goto Lb8
            r5.mkdirs()     // Catch: kotlin.p043io.TerminateException -> Lde
            goto L41
        Lb8:
            r7 = 0
            r8 = 4
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.p043io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch: kotlin.p043io.TerminateException -> Lde
            long r4 = r4.length()     // Catch: kotlin.p043io.TerminateException -> Lde
            long r6 = r3.length()     // Catch: kotlin.p043io.TerminateException -> Lde
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 == 0) goto L41
            java.io.IOException r4 = new java.io.IOException     // Catch: kotlin.p043io.TerminateException -> Lde
            java.lang.String r5 = "Source file wasn't copied completely, length of destination file differs."
            r4.<init>(r5)     // Catch: kotlin.p043io.TerminateException -> Lde
            java.lang.Object r3 = r14.invoke(r3, r4)     // Catch: kotlin.p043io.TerminateException -> Lde
            kotlin.io.OnErrorAction r4 = kotlin.p043io.OnErrorAction.TERMINATE     // Catch: kotlin.p043io.TerminateException -> Lde
            if (r3 != r4) goto L41
            return r2
        Ldd:
        ...
        Lde:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p043io.Utils.copyRecursively(java.io.File, java.io.File, boolean, kotlin.jvm.functions.Function2):boolean");
    }
