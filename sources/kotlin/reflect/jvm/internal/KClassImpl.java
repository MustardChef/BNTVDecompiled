...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public PropertyDescriptor getLocalProperty(int i) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            return ((KClassImpl) JvmClassMapping.getKotlinClass(declaringClass)).getLocalProperty(i);
        }
        ClassDescriptor descriptor = getDescriptor();
        ...
        if (deserializedClassDescriptor != null) {
            ...
            ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtil.getExtensionOrNull(deserializedClassDescriptor.getClassProto(), classLocalVariable, i);
            if (property != null) {
