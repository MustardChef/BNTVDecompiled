...
public final class DeserializedMemberScope$NoReorderImplementation$variableNames$2 extends Lambda implements Functions<Set<? extends Name>> {
    ...
    public final Set<? extends Name> invoke() {
        ...
        for (MessageLite messageLite : list) {
            linkedHashSet.add(NameResolverUtil.getName(deserializedMemberScope.getC().getNameResolver(), ((ProtoBuf.Property) messageLite).getName()));
        }
        return SetsKt.plus((Set) linkedHashSet, (Iterable) this.this$1.getNonDeclaredVariableNames());
    }
}
