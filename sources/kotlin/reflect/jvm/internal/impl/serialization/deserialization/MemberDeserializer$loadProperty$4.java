...
public final class MemberDeserializer$loadProperty$4 extends Lambda implements Functions<NullableLazyValue<? extends ConstantValue<?>>> {
    ...
    /* loaded from: classes4.dex */
    public static final class C52251 extends Lambda implements Functions<ConstantValue<?>> {
        final /* synthetic */ DeserializedPropertyDescriptor $property;
        final /* synthetic */ ProtoBuf.Property $proto;
        final /* synthetic */ MemberDeserializer this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C52251(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
            super(0);
            this.this$0 = memberDeserializer;
            this.$proto = property;
            this.$property = deserializedPropertyDescriptor;
    ...
    public final NullableLazyValue<? extends ConstantValue<?>> invoke() {
        ...
        return deserializationContext.getStorageManager().createNullableLazyValue(new C52251(this.this$0, this.$proto, this.$property));
    }
}
