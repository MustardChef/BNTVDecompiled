...
public final class ReflectionTypes {
    ...
    public ReflectionTypes(ModuleDescriptor module, NotFoundClasses notFoundClasses) {
        ...
        this.kotlinReflectScope$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Functions) new ReflectionTypes$kotlinReflectScope$2(module));
    ...
    public static final class Companion {
        ...
        public final KotlinType createKPropertyStarType(ModuleDescriptor module) {
            Intrinsics.checkNotNullParameter(module, "module");
            ClassDescriptor findClassAcrossModuleDependencies = findClassInModule.findClassAcrossModuleDependencies(module, StandardNames.FqNames.kProperty);
