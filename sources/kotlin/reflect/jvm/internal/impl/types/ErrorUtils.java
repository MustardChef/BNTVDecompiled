...
public class ErrorUtils {
    ...
    private static final ModuleDescriptor ERROR_MODULE = new ModuleDescriptor() { // from class: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.1
        ...
        */
        private static /* synthetic */ void $$$reportNull$$$0(int r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.C52521.$$$reportNull$$$0(int):void");
        }
    ...
    private static PropertyDescriptorImpl createErrorProperty() {
        ...
        create.setType(ERROR_PROPERTY_TYPE, Collections.emptyList(), null, null, Collections.emptyList());
        if (create == null) {
            $$$reportNull$$$0(4);
        }
        return create;
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        /* renamed from: getSupertypes */
        public Collection<KotlinType> mo10322getSupertypes() {
            Collection<KotlinType> mo10322getSupertypes = this.errorTypeConstructor.mo10322getSupertypes();
            if (mo10322getSupertypes == null) {
                $$$reportNull$$$0(3);
            }
        ...
        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public KotlinBuiltIns getBuiltIns() {
            KotlinBuiltIns builtIns = DescriptorUtils.getBuiltIns(this.typeParameterDescriptor);
            if (builtIns == null) {
                $$$reportNull$$$0(4);
            }
            return builtIns;
