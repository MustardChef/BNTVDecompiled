...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaCallableMemberDescriptor
    public JavaMethodDescriptor enhance(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Tuples<CallableDescriptor.UserDataKey<?>, ?> tuples) {
        if (list == null) {
            $$$reportNull$$$0(19);
        }
        if (kotlinType2 == null) {
        ...
        if (tuples != null) {
            javaMethodDescriptor.putInUserDataMap(tuples.getFirst(), tuples.getSecond());
        }
