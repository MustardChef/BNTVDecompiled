...
public final class JavaDeprecatedAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    public JavaDeprecatedAnnotationDescriptor(javaElements javaelements, LazyJavaResolverContext c) {
        super(c, javaelements, StandardNames.FqNames.deprecated);
        Intrinsics.checkNotNullParameter(c, "c");
        this.allValueArguments$delegate = c.getStorageManager().createLazyValue(JavaDeprecatedAnnotationDescriptor$allValueArguments$2.INSTANCE);
    }
