...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public /* bridge */ /* synthetic */ JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, Tuples tuples) {
        return enhance(kotlinType, (List<KotlinType>) list, kotlinType2, (Tuples<CallableDescriptor.UserDataKey<?>, ?>) tuples);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaCallableMemberDescriptor
    public JavaClassConstructorDescriptor enhance(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Tuples<CallableDescriptor.UserDataKey<?>, ?> tuples) {
        if (list == null) {
            $$$reportNull$$$0(16);
        }
        if (kotlinType2 == null) {
        ...
        if (tuples != null) {
            createSubstitutedCopy.putInUserDataMap(tuples.getFirst(), tuples.getSecond());
        }
