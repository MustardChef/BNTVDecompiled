...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private final Tuples<CallableDescriptor.UserDataKey<?>, ?> singleUserData;
    ...
    public JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Tuples<CallableDescriptor.UserDataKey<?>, ?> tuples) {
        ...
        JavaPropertyDescriptor javaPropertyDescriptor = new JavaPropertyDescriptor(getContainingDeclaration(), getAnnotations(), getModality(), getVisibility(), isVar(), getName(), getSource(), original, getKind(), this.isStaticFinal, tuples);
    ...
    public <V> V getUserData(CallableDescriptor.UserDataKey<V> userDataKey) {
        Tuples<CallableDescriptor.UserDataKey<?>, ?> tuples = this.singleUserData;
        if (tuples == null || !tuples.getFirst().equals(userDataKey)) {
            return null;
        }
