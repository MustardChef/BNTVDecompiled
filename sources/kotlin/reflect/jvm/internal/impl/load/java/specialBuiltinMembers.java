...
public final class specialBuiltinMembers extends SpecialGenericSignatures {
    ...
    public final boolean isBuiltinFunctionWithDifferentNameInJvm(SimpleFunctionDescriptor functionDescriptor) {
        Intrinsics.checkNotNullParameter(functionDescriptor, "functionDescriptor");
        return KotlinBuiltIns.isBuiltIn(functionDescriptor) && DescriptorUtils.firstOverridden$default(functionDescriptor, false, new C5084x6ce919c0(functionDescriptor), 1, null) != null;
    }
