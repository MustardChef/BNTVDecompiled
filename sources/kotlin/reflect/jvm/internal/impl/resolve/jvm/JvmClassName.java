...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        return new JvmClassName(packageFqName.asString().replace('.', JsonPointer.SEPARATOR) + "/" + replace);
    }
    ...
    public static JvmClassName byFqNameWithoutInnerClasses(FqName fqName) {
        ...
        JvmClassName jvmClassName = new JvmClassName(fqName.asString().replace('.', JsonPointer.SEPARATOR));
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.internalName.replace(JsonPointer.SEPARATOR, '.'));
    }
    ...
    public FqName getPackageFqName() {
        ...
        return new FqName(this.internalName.substring(0, lastIndexOf).replace(JsonPointer.SEPARATOR, '.'));
    }
