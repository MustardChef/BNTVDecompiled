...
final class Java8ParameterNamesLoader {
    ...
    public final Cache buildCache(Member member) {
        ...
        try {
            return new Cache(cls.getMethod("getParameters", new Class[0]), reflectClassUtil.getSafeClassLoader(cls).loadClass("java.lang.reflect.Parameter").getMethod("getName", new Class[0]));
