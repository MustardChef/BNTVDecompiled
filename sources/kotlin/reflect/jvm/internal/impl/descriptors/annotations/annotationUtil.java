...
/* renamed from: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt */
...
public final class annotationUtil {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(KotlinBuiltIns kotlinBuiltIns, String message, String replaceWith, String level) {
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, StandardNames.FqNames.replaceWith, MapsKt.mapOf(TuplesKt.m100to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(replaceWith)), TuplesKt.m100to(REPLACE_WITH_IMPORTS_NAME, new ArrayValue(CollectionsKt.emptyList(), new C5067xf14e0c1a(kotlinBuiltIns)))));
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt.mapOf(TuplesKt.m100to(DEPRECATED_MESSAGE_NAME, new StringValue(message)), TuplesKt.m100to(DEPRECATED_REPLACE_WITH_NAME, new constantValues(builtInAnnotationDescriptor)), TuplesKt.m100to(name, new EnumValue(classId, identifier))));
    }
