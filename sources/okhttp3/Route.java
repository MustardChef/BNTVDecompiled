...
public final class Route {
    ...
    public final Address m10701deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m10702deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m10703deprecated_socketAddress() {
        return this.socketAddress;
    }
    ...
    public String toString() {
        ...
        if (address().url().port() != socketAddress().getPort() || Intrinsics.areEqual(host, canonicalHost)) {
            sb.append(":");
