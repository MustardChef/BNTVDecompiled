...
public final class TaskRunner {
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    if (isLoggable) {
                        ...
                        TaskLogger.log(logger$okhttp, awaitTaskToRun, queue$okhttp, "starting");
                    }
                    try {
                        taskRunner2.runTask(awaitTaskToRun);
                        Unit unit = Unit.INSTANCE;
                        if (isLoggable) {
                            TaskLogger.log(logger$okhttp, awaitTaskToRun, queue$okhttp, Intrinsics.stringPlus("finished run in ", TaskLogger.formatDuration(queue$okhttp.getTaskRunner$okhttp().getBackend().nanoTime() - j)));
                        }
                    } catch (Throwable th) {
                        if (isLoggable) {
                            TaskLogger.log(logger$okhttp, awaitTaskToRun, queue$okhttp, Intrinsics.stringPlus("failed a run in ", TaskLogger.formatDuration(queue$okhttp.getTaskRunner$okhttp().getBackend().nanoTime() - j)));
                        }
                        throw th;
                    }
                }
    ...
    /* compiled from: TaskRunner.kt */
    @Metadata(m108d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, m107d2 = {"Lokhttp3/internal/concurrent/TaskRunner$Companion;", "", "()V", "INSTANCE", "Lokhttp3/internal/concurrent/TaskRunner;", "logger", "Ljava/util/logging/Logger;", "getLogger", "()Ljava/util/logging/Logger;", "okhttp"}, m106k = 1, m105mv = {1, 6, 0}, m103xi = 48)
    /* loaded from: classes4.dex */
