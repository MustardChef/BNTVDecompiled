...
public final class WebSocketReader implements Closeable {
    ...
    /* compiled from: WebSocketReader.kt */
    @Metadata(m108d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&J\u0010\u0010\b\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\u0007H&J\u0010\u0010\b\u001a\u00020\u00032\u0006\u0010\n\u001a\u00020\u000bH&J\u0010\u0010\f\u001a\u00020\u00032\u0006\u0010\r\u001a\u00020\u000bH&J\u0010\u0010\u000e\u001a\u00020\u00032\u0006\u0010\r\u001a\u00020\u000bH&¨\u0006\u000f"}, m107d2 = {"Lokhttp3/internal/ws/WebSocketReader$FrameCallback;", "", "onReadClose", "", "code", "", "reason", "", "onReadMessage", "text", "bytes", "Lokio/ByteString;", "onReadPing", "payload", "onReadPong", "okhttp"}, m106k = 1, m105mv = {1, 6, 0}, m103xi = 48)
    ...
    private final void readControlFrame() throws IOException {
        ...
        switch (this.opcode) {
            ...
            case 10:
                ...
                return;
            default:
                throw new ProtocolException(Intrinsics.stringPlus("Unknown control opcode: ", _UtilJvmKt.toHexString(this.opcode)));
        }
    }
    ...
    private final void readMessageFrame() throws IOException {
        int i = this.opcode;
        if (i != 1 && i != 2) {
            throw new ProtocolException(Intrinsics.stringPlus("Unknown opcode: ", _UtilJvmKt.toHexString(i)));
        }
        readMessage();
    ...
    private final void readMessage() throws IOException {
        while (!this.closed) {
            ...
            if (this.opcode != 0) {
                throw new ProtocolException(Intrinsics.stringPlus("Expected continuation opcode. Got: ", _UtilJvmKt.toHexString(this.opcode)));
            }
        }
        throw new IOException("closed");
    }
