...
public class BlurTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f10608ID = "jp.wasabeef.glide.transformations.BlurTransformation.1";
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f10608ID + this.radius + this.sampling).getBytes(CHARSET));
    }
}
