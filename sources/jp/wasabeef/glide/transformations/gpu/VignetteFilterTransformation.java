...
public class VignetteFilterTransformation extends GPUFilterTransformation {
    ...
    /* renamed from: ID */
    private static final String f10629ID = "jp.wasabeef.glide.transformations.gpu.VignetteFilterTransformation.1";
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f10629ID + this.center + Arrays.hashCode(this.vignetteColor) + this.vignetteStart + this.vignetteEnd).getBytes(CHARSET));
    }
}
