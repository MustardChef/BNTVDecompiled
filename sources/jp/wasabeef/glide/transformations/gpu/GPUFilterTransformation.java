...
public class GPUFilterTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f10621ID = "jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation.1";
    private static final byte[] ID_BYTES = f10621ID.getBytes(CHARSET);
