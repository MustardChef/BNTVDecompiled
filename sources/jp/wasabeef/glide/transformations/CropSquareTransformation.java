...
public class CropSquareTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f10611ID = "jp.wasabeef.glide.transformations.CropSquareTransformation.1";
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f10611ID + this.size).getBytes(CHARSET));
    }
}
