...
public class ColorFilterTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f10609ID = "jp.wasabeef.glide.transformations.ColorFilterTransformation.1";
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f10609ID + this.color).getBytes(CHARSET));
    }
}
