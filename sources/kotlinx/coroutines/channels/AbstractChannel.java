...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo10513receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m10533closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m10535successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            java.lang.Object r5 = r5.m10532unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo10513receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object mo10514tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m10534failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m10533closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m10535successJP2dKIU(pollInternal);
    }
    ...
    public final void cancel(CancellationException cancellationException) {
        ...
        if (cancellationException == null) {
            cancellationException = new CancellationException(Intrinsics.stringPlus(DebugStrings.getClassSimpleName(this), " was cancelled"));
        }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m10552constructorimpl$default = InlineList.m10552constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.remove()) {
                    ...
                    m10552constructorimpl$default = InlineList.m10557plusFjFbRPM(m10552constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo10512onCancelIdempotentListww6eGU(m10552constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            Undispatched.startCoroutineUnintercepted(function2, ChannelResult.m10520boximpl(z ? companion.m10533closedJP2dKIU(((Closed) obj).closeCause) : companion.m10535successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            throw StackTraceRecovery.recoverStackTrace(((Closed) obj).getReceiveException());
        } else {
            if (i == 1 && selectInstance.trySelect()) {
                Undispatched.startCoroutineUnintercepted(function2, ChannelResult.m10520boximpl(ChannelResult.Companion.m10533closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m9066constructorimpl(boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    cancellableContinuationImpl.resume(boxBoolean, function1 == null ? null : OnUndeliveredElement.bindCancellationFun(function1, pollInternal, cancellableContinuationImpl.getContext()));
                }
            }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m10520boximpl(ChannelResult.Companion.m10535successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m9066constructorimpl(ChannelResult.m10520boximpl(ChannelResult.Companion.m10533closedJP2dKIU(closed.closeCause))));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            Cancellable.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m10520boximpl(ChannelResult.Companion.m10535successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    Cancellable.startCoroutineCancellable$default(this.block, ChannelResult.m10520boximpl(ChannelResult.Companion.m10533closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo10512onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
