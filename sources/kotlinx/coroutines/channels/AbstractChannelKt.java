...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m10533closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m10535successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m10533closedJP2dKIU(closed.closeCause);
    }
}
