                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        ...
                        if (send2 instanceof AbstractSendChannel.SendBuffered) {
                            ...
                            undeliveredElementException2 = function12 == null ? null : OnUndeliveredElement.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementException2);
                        } else {
