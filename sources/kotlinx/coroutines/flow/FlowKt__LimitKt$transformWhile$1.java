...
@DebugMetadata(m99c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m98f = "Limit.kt", m97i = {0}, m96l = {153}, m95m = "invokeSuspend", m94n = {"collector$iv"}, m93s = {"L$0"})
...
public final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C5303xdf1aa1b6 c5303xdf1aa1b6;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C5303xdf1aa1b6 c5303xdf1aa1b62 = new C5303xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
                this.L$0 = c5303xdf1aa1b62;
                this.label = 1;
                if (flow.collect(c5303xdf1aa1b62, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (FlowExceptions e) {
                e = e;
                c5303xdf1aa1b6 = c5303xdf1aa1b62;
                FlowExceptions_commonKt.checkOwnership(e, c5303xdf1aa1b6);
                return Unit.INSTANCE;
            }
        } else if (i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        } else {
            c5303xdf1aa1b6 = (C5303xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
