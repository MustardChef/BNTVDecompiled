...
public final /* synthetic */ class Delay {
    ...
    public static final <T> Flow<T> m10541debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m10498toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m10542sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m10498toDelayMillisLRDsOJo(j));
    }
}
