...
public final class StackTraceRecovery {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m9066constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m9066constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m9069exceptionOrNullimpl(obj) == null) {
            obj4 = obj;
        }
        baseContinuationImplClassName = (String) obj4;
        try {
            Result.Companion companion3 = Result.Companion;
            obj2 = Result.m9066constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m9066constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m9069exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
