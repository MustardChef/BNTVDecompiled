...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m9066constructorimpl = Result.m9066constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9066constructorimpl = Result.m9066constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m9072isFailureimpl(m9066constructorimpl) ? null : m9066constructorimpl;
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerDispatcherKt$Z1vOW_gMqzuAA1kBf19jmX0gPxw
            @Override // android.view.Choreographer.FrameCallback
            public final void doFrame(long j) {
                HandlerDispatcherKt.m10511postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m10511postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
