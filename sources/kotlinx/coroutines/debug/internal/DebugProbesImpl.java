...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            m9066constructorimpl = Result.m9066constructorimpl(ResultKt.createFailure(th));
        }
        if (newInstance != null) {
            m9066constructorimpl = Result.m9066constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m9072isFailureimpl(m9066constructorimpl)) {
                m9066constructorimpl = null;
            }
            return (Function1) m9066constructorimpl;
        }
    ...
    private final void startWeakRefCleanerThread() {
        Thread thread;
        thread = Thread.thread((r12 & 1) != 0, (r12 & 2) != 0 ? false : true, (r12 & 4) != 0 ? null : null, (r12 & 8) != 0 ? null : "Coroutines Debugger Cleaner", (r12 & 16) != 0 ? -1 : 0, DebugProbesImpl$startWeakRefCleanerThread$1.INSTANCE);
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> function2) {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C5278x8808a3e8()), new DebugProbesImpl$dumpCoroutinesInfoImpl$1$3(function2)));
        } finally {
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            m9066constructorimpl = Result.m9066constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9066constructorimpl = Result.m9066constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m9066constructorimpl;
    ...
    private final Tuples<Integer, Integer> findContinuationStartIndex(int i, StackTraceElement[] stackTraceElementArr, List<StackTraceElement> list) {
        ...
        while (i2 < 3) {
            ...
            if (findIndexOfFrame != -1) {
                return TuplesKt.m100to(Integer.valueOf(findIndexOfFrame), Integer.valueOf(i2));
            }
            i2 = i3;
        }
        return TuplesKt.m100to(-1, 0);
    }
    ...
    public final List<DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C5278x8808a3e8()), new C5277x49f1cbae()));
        } finally {
            while (i < readHoldCount) {
                i++;
                readLock.lock();
    ...
    public final List<DebuggerInfo> dumpDebuggerInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C5278x8808a3e8()), new C5280xee7de334()));
        } finally {
            while (i < readHoldCount) {
                i++;
                readLock.lock();
