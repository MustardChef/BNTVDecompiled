...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    private final String getStateDebugRepresentation() {
        ...
        return state$kotlinx_coroutines_core instanceof NotCompleted ? "Active" : state$kotlinx_coroutines_core instanceof CompletionState ? AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_CANCELLED : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_COMPLETED;
    }
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object obj) {
        ...
        return (Debug.getRECOVER_STACK_TRACES() && (delegate$kotlinx_coroutines_core instanceof CoroutineStackFrame)) ? StackTraceRecovery.recoverFromStackFrame(exceptionalResult$kotlinx_coroutines_core, (CoroutineStackFrame) delegate$kotlinx_coroutines_core) : exceptionalResult$kotlinx_coroutines_core;
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!_state$FU.compareAndSet(this, obj, new CompletionState(this, th, z)));
