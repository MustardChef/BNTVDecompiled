...
public final class KotlinExtensions {
    ...
    */
    ...
    public static final <T> Object await(Call<T> call, Continuation<? super T> continuation) {
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new C5558x19835f10(call));
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (body == null) {
                        ...
                        CancellableContinuation.this.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    Result.Companion companion2 = Result.Companion;
                    CancellableContinuation.this.resumeWith(Result.m9066constructorimpl(body));
                    return;
                }
                Result.Companion companion3 = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(new HttpException(response))));
            }
            ...
            public void onFailure(Call<T> call2, Throwable t) {
                ...
                Result.Companion companion = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m9066constructorimpl(ResultKt.createFailure(t)));
            }
        });
    ...
    public static final <T> Object awaitNullable(Call<T> call, Continuation<? super T> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        final CancellableContinuationImpl cancellableContinuationImpl2 = cancellableContinuationImpl;
        cancellableContinuationImpl2.invokeOnCancellation(new C5559x19835f11(call));
    ...
    public static final <T> Object awaitResponse(Call<T> call, Continuation<? super Response<T>> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        final CancellableContinuationImpl cancellableContinuationImpl2 = cancellableContinuationImpl;
        cancellableContinuationImpl2.invokeOnCancellation(new C5560xc95e9eb1(call));
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                Intrinsics.checkParameterIsNotNull(response, "response");
                Result.Companion companion = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m9066constructorimpl(response));
            }
